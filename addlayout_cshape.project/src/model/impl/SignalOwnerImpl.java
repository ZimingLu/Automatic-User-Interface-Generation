 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SignalOwnerImpl#getSignal <em>Signal</em>}</li>
 *   <li>{@link model.impl.SignalOwnerImpl#getSignalMap <em>Signal Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SignalOwnerImpl extends SingleSourceNodeImpl implements SignalOwner {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getSignalOwner();
	}
	...
	public EList<Signal> getSignal() {
		if (signal == null) {
			signal = new EObjectContainmentEList<Signal>(Signal.class, this, ModelPackage.SIGNAL_OWNER__SIGNAL);
		}
		return signal;
	}
	...
	public EList<SignalMap> getSignalMap() {
		if (signalMap == null) {
			signalMap = new EObjectContainmentEList<SignalMap>(SignalMap.class, this, ModelPackage.SIGNAL_OWNER__SIGNAL_MAP);
		}
		return signalMap;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SIGNAL_OWNER__SIGNAL:
				return ((InternalEList<?>)getSignal()).basicRemove(otherEnd, msgs);
			case ModelPackage.SIGNAL_OWNER__SIGNAL_MAP:
