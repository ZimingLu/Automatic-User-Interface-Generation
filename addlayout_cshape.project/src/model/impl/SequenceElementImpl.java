 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SequenceElementImpl#getDataWidth <em>Data Width</em>}</li>
 *   <li>{@link model.impl.SequenceElementImpl#getAccessCondition <em>Access Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SequenceElementImpl extends RegMemElementImpl implements SequenceElement {
	 ...
	 * @ordered
	 */
	protected static final String DATA_WIDTH_EDEFAULT = "32";
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getSequenceElement();
	}
	...
	public void setDataWidth(String newDataWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SEQUENCE_ELEMENT__DATA_WIDTH, oldDataWidth, dataWidth));
	}
	...
	public EList<AccessCondition> getAccessCondition() {
		if (accessCondition == null) {
			accessCondition = new EObjectContainmentEList<AccessCondition>(AccessCondition.class, this, ModelPackage.SEQUENCE_ELEMENT__ACCESS_CONDITION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SEQUENCE_ELEMENT__ACCESS_CONDITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.SEQUENCE_ELEMENT__DATA_WIDTH:
				return getDataWidth();
			case ModelPackage.SEQUENCE_ELEMENT__ACCESS_CONDITION:
