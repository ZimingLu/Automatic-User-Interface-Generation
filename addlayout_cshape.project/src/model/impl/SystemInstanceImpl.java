 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SystemInstanceImpl#getInstanceShellInterfaceMap <em>Instance Shell Interface Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemInstanceImpl extends InterfaceInstanceImpl implements SystemInstance {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getSystemInstance();
	}
	...
	public EList<InstanceShellInterfaceMap> getInstanceShellInterfaceMap() {
		if (instanceShellInterfaceMap == null) {
			instanceShellInterfaceMap = new EObjectContainmentEList<InstanceShellInterfaceMap>(InstanceShellInterfaceMap.class, this, ModelPackage.SYSTEM_INSTANCE__INSTANCE_SHELL_INTERFACE_MAP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SYSTEM_INSTANCE__INSTANCE_SHELL_INTERFACE_MAP:
