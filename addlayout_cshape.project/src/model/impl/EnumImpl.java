 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.EnumImpl#getEnumElement <em>Enum Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumImpl extends ComplexDataTypeImpl implements model.Enum {
	/**
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getEnum();
	}
	...
	public EList<EnumElement> getEnumElement() {
		if (enumElement == null) {
			enumElement = new EObjectContainmentEList<EnumElement>(EnumElement.class, this, ModelPackage.ENUM__ENUM_ELEMENT);
		}
		return enumElement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.ENUM__ENUM_ELEMENT:
