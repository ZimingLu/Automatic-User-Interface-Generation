 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.GeneralInstanceImpl#getExtVLNV <em>Ext VLNV</em>}</li>
 *   <li>{@link model.impl.GeneralInstanceImpl#getParamMap <em>Param Map</em>}</li>
 *   <li>{@link model.impl.GeneralInstanceImpl#getGenericMap <em>Generic Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GeneralInstanceImpl extends SingleSourceNodeImpl implements GeneralInstance {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getGeneralInstance();
	}
	...
	public NotificationChain basicSetExtVLNV(VLNV newExtVLNV, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.GENERAL_INSTANCE__EXT_VLNV, oldExtVLNV, newExtVLNV);
	...
	public void setExtVLNV(VLNV newExtVLNV) {
		if (newExtVLNV != extVLNV) {
			...
			if (extVLNV != null)
				msgs = ((InternalEObject)extVLNV).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.GENERAL_INSTANCE__EXT_VLNV, null, msgs);
			if (newExtVLNV != null)
				msgs = ((InternalEObject)newExtVLNV).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.GENERAL_INSTANCE__EXT_VLNV, null, msgs);
			msgs = basicSetExtVLNV(newExtVLNV, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.GENERAL_INSTANCE__EXT_VLNV, newExtVLNV, newExtVLNV));
	}
	...
	public EList<ParamMap> getParamMap() {
		if (paramMap == null) {
			paramMap = new EObjectContainmentEList<ParamMap>(ParamMap.class, this, ModelPackage.GENERAL_INSTANCE__PARAM_MAP);
		}
		return paramMap;
	}
	...
	public EList<GenericMap> getGenericMap() {
		if (genericMap == null) {
			genericMap = new EObjectContainmentEList<GenericMap>(GenericMap.class, this, ModelPackage.GENERAL_INSTANCE__GENERIC_MAP);
		}
		return genericMap;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.GENERAL_INSTANCE__EXT_VLNV:
				return basicSetExtVLNV(null, msgs);
			case ModelPackage.GENERAL_INSTANCE__PARAM_MAP:
				return ((InternalEList<?>)getParamMap()).basicRemove(otherEnd, msgs);
			case ModelPackage.GENERAL_INSTANCE__GENERIC_MAP:
