 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SiInstanceShellInterfaceMapImpl#getXRefInstanceShellInterface <em>XRef Instance Shell Interface</em>}</li>
 *   <li>{@link model.impl.SiInstanceShellInterfaceMapImpl#getSiInstanceShellPortMap <em>Si Instance Shell Port Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiInstanceShellInterfaceMapImpl extends SingleSourceNodeImpl implements SiInstanceShellInterfaceMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getSiInstanceShellInterfaceMap();
	}
	...
	public NotificationChain basicSetXRefInstanceShellInterface(XRefIndInterface newXRefInstanceShellInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SI_INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE, oldXRefInstanceShellInterface, newXRefInstanceShellInterface);
	...
	public void setXRefInstanceShellInterface(XRefIndInterface newXRefInstanceShellInterface) {
		if (newXRefInstanceShellInterface != xRefInstanceShellInterface) {
			...
			if (xRefInstanceShellInterface != null)
				msgs = ((InternalEObject)xRefInstanceShellInterface).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE, null, msgs);
			if (newXRefInstanceShellInterface != null)
				msgs = ((InternalEObject)newXRefInstanceShellInterface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE, null, msgs);
			msgs = basicSetXRefInstanceShellInterface(newXRefInstanceShellInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SI_INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE, newXRefInstanceShellInterface, newXRefInstanceShellInterface));
	}
	...
	public EList<SiInstanceShellPortMap> getSiInstanceShellPortMap() {
		if (siInstanceShellPortMap == null) {
			siInstanceShellPortMap = new EObjectContainmentEList<SiInstanceShellPortMap>(SiInstanceShellPortMap.class, this, ModelPackage.SI_INSTANCE_SHELL_INTERFACE_MAP__SI_INSTANCE_SHELL_PORT_MAP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SI_INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE:
				return basicSetXRefInstanceShellInterface(null, msgs);
			case ModelPackage.SI_INSTANCE_SHELL_INTERFACE_MAP__SI_INSTANCE_SHELL_PORT_MAP:
