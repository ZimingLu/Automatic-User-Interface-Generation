 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.UnionImpl#getDataTypeElement <em>Data Type Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnionImpl extends ComplexDataTypeImpl implements Union {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getUnion();
	}
	...
	public EList<DataTypeElement> getDataTypeElement() {
		if (dataTypeElement == null) {
			dataTypeElement = new EObjectContainmentEList<DataTypeElement>(DataTypeElement.class, this, ModelPackage.UNION__DATA_TYPE_ELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.UNION__DATA_TYPE_ELEMENT:
