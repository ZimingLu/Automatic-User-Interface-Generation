 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ShellInterfaceMapImpl#getXRefShellInterface <em>XRef Shell Interface</em>}</li>
 *   <li>{@link model.impl.ShellInterfaceMapImpl#getXRefConnection <em>XRef Connection</em>}</li>
 *   <li>{@link model.impl.ShellInterfaceMapImpl#getShellPortMap <em>Shell Port Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShellInterfaceMapImpl extends SingleSourceNodeImpl implements ShellInterfaceMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getShellInterfaceMap();
	}
	...
	public NotificationChain basicSetXRefShellInterface(XRefExternalInterface newXRefShellInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SHELL_INTERFACE_MAP__XREF_SHELL_INTERFACE, oldXRefShellInterface, newXRefShellInterface);
	...
	public void setXRefShellInterface(XRefExternalInterface newXRefShellInterface) {
		if (newXRefShellInterface != xRefShellInterface) {
			...
			if (xRefShellInterface != null)
				msgs = ((InternalEObject)xRefShellInterface).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SHELL_INTERFACE_MAP__XREF_SHELL_INTERFACE, null, msgs);
			if (newXRefShellInterface != null)
				msgs = ((InternalEObject)newXRefShellInterface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SHELL_INTERFACE_MAP__XREF_SHELL_INTERFACE, null, msgs);
			msgs = basicSetXRefShellInterface(newXRefShellInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SHELL_INTERFACE_MAP__XREF_SHELL_INTERFACE, newXRefShellInterface, newXRefShellInterface));
	}
	...
	public NotificationChain basicSetXRefConnection(XRefConnection newXRefConnection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SHELL_INTERFACE_MAP__XREF_CONNECTION, oldXRefConnection, newXRefConnection);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefConnection(XRefConnection newXRefConnection) {
		if (newXRefConnection != xRefConnection) {
			...
			if (xRefConnection != null)
				msgs = ((InternalEObject)xRefConnection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SHELL_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			if (newXRefConnection != null)
				msgs = ((InternalEObject)newXRefConnection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SHELL_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			msgs = basicSetXRefConnection(newXRefConnection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SHELL_INTERFACE_MAP__XREF_CONNECTION, newXRefConnection, newXRefConnection));
	}
	...
	public EList<ShellPortMap> getShellPortMap() {
		if (shellPortMap == null) {
			shellPortMap = new EObjectContainmentEList<ShellPortMap>(ShellPortMap.class, this, ModelPackage.SHELL_INTERFACE_MAP__SHELL_PORT_MAP);
		}
		return shellPortMap;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SHELL_INTERFACE_MAP__XREF_SHELL_INTERFACE:
				return basicSetXRefShellInterface(null, msgs);
			case ModelPackage.SHELL_INTERFACE_MAP__XREF_CONNECTION:
				return basicSetXRefConnection(null, msgs);
			case ModelPackage.SHELL_INTERFACE_MAP__SHELL_PORT_MAP:
