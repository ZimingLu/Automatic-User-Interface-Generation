 ...
 * </p>
 * <ul>
 *   <li>{@link model.Connection#getExtVLNV <em>Ext VLNV</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getConnection()
...
public interface Connection extends SignalOwner {
	 ...
	 * @see #setExtVLNV(VLNV)
	 * @see model.ModelPackage#getConnection_ExtVLNV()
	...
	/**
	 * Sets the value of the '{@link model.Connection#getExtVLNV <em>Ext VLNV</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
