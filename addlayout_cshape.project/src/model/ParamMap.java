 ...
 * </p>
 * <ul>
 *   <li>{@link model.ParamMap#getXRefParamDecl <em>XRef Param Decl</em>}</li>
 *   <li>{@link model.ParamMap#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getParamMap()
...
public interface ParamMap extends SingleSourceNode {
	 ...
	 * @see model.ModelPackage#getParamMap_XRefParamDecl()
	...
	/**
	 * Sets the value of the '{@link model.ParamMap#getXRefParamDecl <em>XRef Param Decl</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setValue(String)
	 * @see model.ModelPackage#getParamMap_Value()
	...
	/**
	 * Sets the value of the '{@link model.ParamMap#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
