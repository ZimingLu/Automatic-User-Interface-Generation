 ...
 * </p>
 * <ul>
 *   <li>{@link model.ShellPortMap#getXRefShellPort <em>XRef Shell Port</em>}</li>
 *   <li>{@link model.ShellPortMap#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getShellPortMap()
...
public interface ShellPortMap extends SingleSourceNode {
	 ...
	 * @see model.ModelPackage#getShellPortMap_XRefShellPort()
	...
	/**
	 * Sets the value of the '{@link model.ShellPortMap#getXRefShellPort <em>XRef Shell Port</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model.ModelPackage#getShellPortMap_XRefSignal()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link model.ShellPortMap#getXRefSignal <em>XRef Signal</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
