 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.InterfaceDefViewImpl#getInterfaceDefRole <em>Interface Def Role</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceDefViewImpl extends SignalOwnerImpl implements InterfaceDefView {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getInterfaceDefView();
	}
	...
	public EList<InterfaceDefRole> getInterfaceDefRole() {
		if (interfaceDefRole == null) {
			interfaceDefRole = new EObjectContainmentEList<InterfaceDefRole>(InterfaceDefRole.class, this, ModelPackage.INTERFACE_DEF_VIEW__INTERFACE_DEF_ROLE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.INTERFACE_DEF_VIEW__INTERFACE_DEF_ROLE:
