 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.LocalInterfaceMapImpl#getXRefLocalInterface <em>XRef Local Interface</em>}</li>
 *   <li>{@link model.impl.LocalInterfaceMapImpl#getXRefConnection <em>XRef Connection</em>}</li>
 *   <li>{@link model.impl.LocalInterfaceMapImpl#getLocalPortMap <em>Local Port Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocalInterfaceMapImpl extends SingleSourceNodeImpl implements LocalInterfaceMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getLocalInterfaceMap();
	}
	...
	public NotificationChain basicSetXRefLocalInterface(XRefInternalInterface newXRefLocalInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.LOCAL_INTERFACE_MAP__XREF_LOCAL_INTERFACE, oldXRefLocalInterface, newXRefLocalInterface);
	...
	public void setXRefLocalInterface(XRefInternalInterface newXRefLocalInterface) {
		if (newXRefLocalInterface != xRefLocalInterface) {
			...
			if (xRefLocalInterface != null)
				msgs = ((InternalEObject)xRefLocalInterface).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.LOCAL_INTERFACE_MAP__XREF_LOCAL_INTERFACE, null, msgs);
			if (newXRefLocalInterface != null)
				msgs = ((InternalEObject)newXRefLocalInterface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.LOCAL_INTERFACE_MAP__XREF_LOCAL_INTERFACE, null, msgs);
			msgs = basicSetXRefLocalInterface(newXRefLocalInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LOCAL_INTERFACE_MAP__XREF_LOCAL_INTERFACE, newXRefLocalInterface, newXRefLocalInterface));
	}
	...
	public NotificationChain basicSetXRefConnection(XRefConnection newXRefConnection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.LOCAL_INTERFACE_MAP__XREF_CONNECTION, oldXRefConnection, newXRefConnection);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefConnection(XRefConnection newXRefConnection) {
		if (newXRefConnection != xRefConnection) {
			...
			if (xRefConnection != null)
				msgs = ((InternalEObject)xRefConnection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.LOCAL_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			if (newXRefConnection != null)
				msgs = ((InternalEObject)newXRefConnection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.LOCAL_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			msgs = basicSetXRefConnection(newXRefConnection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LOCAL_INTERFACE_MAP__XREF_CONNECTION, newXRefConnection, newXRefConnection));
	}
	...
	public EList<LocalPortMap> getLocalPortMap() {
		if (localPortMap == null) {
			localPortMap = new EObjectContainmentEList<LocalPortMap>(LocalPortMap.class, this, ModelPackage.LOCAL_INTERFACE_MAP__LOCAL_PORT_MAP);
		}
		return localPortMap;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.LOCAL_INTERFACE_MAP__XREF_LOCAL_INTERFACE:
				return basicSetXRefLocalInterface(null, msgs);
			case ModelPackage.LOCAL_INTERFACE_MAP__XREF_CONNECTION:
				return basicSetXRefConnection(null, msgs);
			case ModelPackage.LOCAL_INTERFACE_MAP__LOCAL_PORT_MAP:
