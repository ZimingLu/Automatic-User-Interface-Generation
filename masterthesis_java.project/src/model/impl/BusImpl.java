 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.BusImpl#getExtVLNV <em>Ext VLNV</em>}</li>
 *   <li>{@link model.impl.BusImpl#getMaxMasters <em>Max Masters</em>}</li>
 *   <li>{@link model.impl.BusImpl#getMaxSlaves <em>Max Slaves</em>}</li>
 *   <li>{@link model.impl.BusImpl#getNoneInterface <em>None Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BusImpl extends ModelRootImpl implements Bus {
	 ...
	 * @ordered
	 */
	protected static final String MAX_MASTERS_EDEFAULT = "1";
	 ...
	 * @ordered
	 */
	protected static final String MAX_SLAVES_EDEFAULT = "1";
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getBus();
	}
	...
	public NotificationChain basicSetExtVLNV(VLNV newExtVLNV, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.BUS__EXT_VLNV, oldExtVLNV, newExtVLNV);
	...
	public void setExtVLNV(VLNV newExtVLNV) {
		if (newExtVLNV != extVLNV) {
			...
			if (extVLNV != null)
				msgs = ((InternalEObject)extVLNV).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.BUS__EXT_VLNV, null, msgs);
			if (newExtVLNV != null)
				msgs = ((InternalEObject)newExtVLNV).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.BUS__EXT_VLNV, null, msgs);
			msgs = basicSetExtVLNV(newExtVLNV, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.BUS__EXT_VLNV, newExtVLNV, newExtVLNV));
	}
	...
	public void setMaxMasters(String newMaxMasters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.BUS__MAX_MASTERS, oldMaxMasters, maxMasters));
	}
	...
	public void setMaxSlaves(String newMaxSlaves) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.BUS__MAX_SLAVES, oldMaxSlaves, maxSlaves));
	}
	...
	public EList<NoneInterface> getNoneInterface() {
		if (noneInterface == null) {
			noneInterface = new EObjectContainmentEList<NoneInterface>(NoneInterface.class, this, ModelPackage.BUS__NONE_INTERFACE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.BUS__EXT_VLNV:
				return basicSetExtVLNV(null, msgs);
			case ModelPackage.BUS__NONE_INTERFACE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.BUS__EXT_VLNV:
				return getExtVLNV();
			case ModelPackage.BUS__MAX_MASTERS:
				return getMaxMasters();
			case ModelPackage.BUS__MAX_SLAVES:
				return getMaxSlaves();
			case ModelPackage.BUS__NONE_INTERFACE:
