 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SinglePadImpl#getXCoordinate <em>XCoordinate</em>}</li>
 *   <li>{@link model.impl.SinglePadImpl#getYCoordinate <em>YCoordinate</em>}</li>
 *   <li>{@link model.impl.SinglePadImpl#getSpacer <em>Spacer</em>}</li>
 *   <li>{@link model.impl.SinglePadImpl#getOpening <em>Opening</em>}</li>
 *   <li>{@link model.impl.SinglePadImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link model.impl.SinglePadImpl#getPadCount <em>Pad Count</em>}</li>
 *   <li>{@link model.impl.SinglePadImpl#getPlace <em>Place</em>}</li>
 *   <li>{@link model.impl.SinglePadImpl#getOrientation <em>Orientation</em>}</li>
 *   <li>{@link model.impl.SinglePadImpl#getPower <em>Power</em>}</li>
 *   <li>{@link model.impl.SinglePadImpl#getGround <em>Ground</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SinglePadImpl extends PadImpl implements SinglePad {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getSinglePad();
	}
	...
	public void setXCoordinate(String newXCoordinate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__XCOORDINATE, oldXCoordinate, xCoordinate));
	}
	...
	public void setYCoordinate(String newYCoordinate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__YCOORDINATE, oldYCoordinate, yCoordinate));
	}
	...
	public void setSpacer(String newSpacer) {
		...
		spacer = newSpacer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__SPACER, oldSpacer, spacer));
	}
	...
	public void setOpening(String newOpening) {
		...
		opening = newOpening;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__OPENING, oldOpening, opening));
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__LOCATION, oldLocation, location));
	}
	...
	public void setPadCount(String newPadCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__PAD_COUNT, oldPadCount, padCount));
	}
	...
	public void setPlace(String newPlace) {
		...
		place = newPlace;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__PLACE, oldPlace, place));
	}
	...
	public void setOrientation(String newOrientation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__ORIENTATION, oldOrientation, orientation));
	}
	...
	public void setPower(String newPower) {
		...
		power = newPower;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__POWER, oldPower, power));
	}
	...
	public void setGround(String newGround) {
		...
		ground = newGround;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SINGLE_PAD__GROUND, oldGround, ground));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.SINGLE_PAD__XCOORDINATE:
				return getXCoordinate();
			case ModelPackage.SINGLE_PAD__YCOORDINATE:
				return getYCoordinate();
			case ModelPackage.SINGLE_PAD__SPACER:
				return getSpacer();
			case ModelPackage.SINGLE_PAD__OPENING:
				return getOpening();
			case ModelPackage.SINGLE_PAD__LOCATION:
				return getLocation();
			case ModelPackage.SINGLE_PAD__PAD_COUNT:
				return getPadCount();
			case ModelPackage.SINGLE_PAD__PLACE:
				return getPlace();
			case ModelPackage.SINGLE_PAD__ORIENTATION:
				return getOrientation();
			case ModelPackage.SINGLE_PAD__POWER:
				return getPower();
			case ModelPackage.SINGLE_PAD__GROUND:
				return getGround();
		}
