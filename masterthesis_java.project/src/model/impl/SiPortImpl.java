 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SiPortImpl#getPdr <em>Pdr</em>}</li>
 *   <li>{@link model.impl.SiPortImpl#getXRefTest <em>XRef Test</em>}</li>
 *   <li>{@link model.impl.SiPortImpl#getSiPortReq <em>Si Port Req</em>}</li>
 *   <li>{@link model.impl.SiPortImpl#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiPortImpl extends SingleSourceNodeImpl implements SiPort {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getSiPort();
	}
	...
	public void setPdr(String newPdr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SI_PORT__PDR, oldPdr, pdr));
	}
	...
	public NotificationChain basicSetXRefTest(XRefTest newXRefTest, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SI_PORT__XREF_TEST, oldXRefTest, newXRefTest);
	...
	public void setXRefTest(XRefTest newXRefTest) {
		if (newXRefTest != xRefTest) {
			...
			if (xRefTest != null)
				msgs = ((InternalEObject)xRefTest).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_PORT__XREF_TEST, null, msgs);
			if (newXRefTest != null)
				msgs = ((InternalEObject)newXRefTest).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_PORT__XREF_TEST, null, msgs);
			msgs = basicSetXRefTest(newXRefTest, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SI_PORT__XREF_TEST, newXRefTest, newXRefTest));
	}
	...
	public NotificationChain basicSetSiPortReq(SiPortReq newSiPortReq, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SI_PORT__SI_PORT_REQ, oldSiPortReq, newSiPortReq);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSiPortReq(SiPortReq newSiPortReq) {
		if (newSiPortReq != siPortReq) {
			NotificationChain msgs = null;
			if (siPortReq != null)
				msgs = ((InternalEObject)siPortReq).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_PORT__SI_PORT_REQ, null, msgs);
			if (newSiPortReq != null)
				msgs = ((InternalEObject)newSiPortReq).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_PORT__SI_PORT_REQ, null, msgs);
			msgs = basicSetSiPortReq(newSiPortReq, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SI_PORT__SI_PORT_REQ, newSiPortReq, newSiPortReq));
	}
	...
	public EList<Function> getFunction() {
		if (function == null) {
			function = new EObjectContainmentEList<Function>(Function.class, this, ModelPackage.SI_PORT__FUNCTION);
		}
		return function;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SI_PORT__XREF_TEST:
				return basicSetXRefTest(null, msgs);
			case ModelPackage.SI_PORT__SI_PORT_REQ:
				return basicSetSiPortReq(null, msgs);
			case ModelPackage.SI_PORT__FUNCTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.SI_PORT__PDR:
				return getPdr();
			case ModelPackage.SI_PORT__XREF_TEST:
				return getXRefTest();
			case ModelPackage.SI_PORT__SI_PORT_REQ:
