 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.PadTypeDBImpl#getPadType <em>Pad Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PadTypeDBImpl extends ModelRootImpl implements PadTypeDB {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getPadTypeDB();
	}
	...
	public EList<PadType> getPadType() {
		if (padType == null) {
			padType = new EObjectContainmentEList<PadType>(PadType.class, this, ModelPackage.PAD_TYPE_DB__PAD_TYPE);
		}
		return padType;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.PAD_TYPE_DB__PAD_TYPE:
