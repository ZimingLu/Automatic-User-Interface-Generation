 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.GeneralInterfaceImpl#getInterfaceView <em>Interface View</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GeneralInterfaceImpl extends SingleSourceNodeImpl implements GeneralInterface {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getGeneralInterface();
	}
	...
	public EList<InterfaceView> getInterfaceView() {
		if (interfaceView == null) {
			interfaceView = new EObjectContainmentEList<InterfaceView>(InterfaceView.class, this, ModelPackage.GENERAL_INTERFACE__INTERFACE_VIEW);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.GENERAL_INTERFACE__INTERFACE_VIEW:
