 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ReturnElementAccessImpl#getSimpleSubElementAccess <em>Simple Sub Element Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnElementAccessImpl extends SubElementAccessImpl implements ReturnElementAccess {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getReturnElementAccess();
	}
	...
	public NotificationChain basicSetSimpleSubElementAccess(SimpleSubElementAccess newSimpleSubElementAccess, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.RETURN_ELEMENT_ACCESS__SIMPLE_SUB_ELEMENT_ACCESS, oldSimpleSubElementAccess, newSimpleSubElementAccess);
	...
	public void setSimpleSubElementAccess(SimpleSubElementAccess newSimpleSubElementAccess) {
		if (newSimpleSubElementAccess != simpleSubElementAccess) {
			...
			if (simpleSubElementAccess != null)
				msgs = ((InternalEObject)simpleSubElementAccess).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.RETURN_ELEMENT_ACCESS__SIMPLE_SUB_ELEMENT_ACCESS, null, msgs);
			if (newSimpleSubElementAccess != null)
				msgs = ((InternalEObject)newSimpleSubElementAccess).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.RETURN_ELEMENT_ACCESS__SIMPLE_SUB_ELEMENT_ACCESS, null, msgs);
			msgs = basicSetSimpleSubElementAccess(newSimpleSubElementAccess, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.RETURN_ELEMENT_ACCESS__SIMPLE_SUB_ELEMENT_ACCESS, newSimpleSubElementAccess, newSimpleSubElementAccess));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.RETURN_ELEMENT_ACCESS__SIMPLE_SUB_ELEMENT_ACCESS:
