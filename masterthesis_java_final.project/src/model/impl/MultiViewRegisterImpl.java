 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.MultiViewRegisterImpl#getXRefRegisterView <em>XRef Register View</em>}</li>
 *   <li>{@link model.impl.MultiViewRegisterImpl#getRegisterView <em>Register View</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiViewRegisterImpl extends GeneralRegisterImpl implements MultiViewRegister {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getMultiViewRegister();
	}
	...
	public EList<XRefRegisterView> getXRefRegisterView() {
		if (xRefRegisterView == null) {
			xRefRegisterView = new EObjectContainmentEList<XRefRegisterView>(XRefRegisterView.class, this, ModelPackage.MULTI_VIEW_REGISTER__XREF_REGISTER_VIEW);
		}
	...
	public EList<RegisterView> getRegisterView() {
		if (registerView == null) {
			registerView = new EObjectContainmentEList<RegisterView>(RegisterView.class, this, ModelPackage.MULTI_VIEW_REGISTER__REGISTER_VIEW);
		}
		return registerView;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.MULTI_VIEW_REGISTER__XREF_REGISTER_VIEW:
				return ((InternalEList<?>)getXRefRegisterView()).basicRemove(otherEnd, msgs);
			case ModelPackage.MULTI_VIEW_REGISTER__REGISTER_VIEW:
