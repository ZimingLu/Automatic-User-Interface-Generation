 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ProductInterfaceMapImpl#getXRefConnection <em>XRef Connection</em>}</li>
 *   <li>{@link model.impl.ProductInterfaceMapImpl#getProductPinMap <em>Product Pin Map</em>}</li>
 *   <li>{@link model.impl.ProductInterfaceMapImpl#getProductPadMap <em>Product Pad Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductInterfaceMapImpl extends SingleSourceNodeImpl implements ProductInterfaceMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getProductInterfaceMap();
	}
	...
	public NotificationChain basicSetXRefConnection(XRefConnection newXRefConnection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.PRODUCT_INTERFACE_MAP__XREF_CONNECTION, oldXRefConnection, newXRefConnection);
	...
	public void setXRefConnection(XRefConnection newXRefConnection) {
		if (newXRefConnection != xRefConnection) {
			...
			if (xRefConnection != null)
				msgs = ((InternalEObject)xRefConnection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PRODUCT_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			if (newXRefConnection != null)
				msgs = ((InternalEObject)newXRefConnection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PRODUCT_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			msgs = basicSetXRefConnection(newXRefConnection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PRODUCT_INTERFACE_MAP__XREF_CONNECTION, newXRefConnection, newXRefConnection));
	}
	...
	public EList<ProductPinMap> getProductPinMap() {
		if (productPinMap == null) {
			productPinMap = new EObjectContainmentEList<ProductPinMap>(ProductPinMap.class, this, ModelPackage.PRODUCT_INTERFACE_MAP__PRODUCT_PIN_MAP);
		}
	...
	public EList<ProductPadMap> getProductPadMap() {
		if (productPadMap == null) {
			productPadMap = new EObjectContainmentEList<ProductPadMap>(ProductPadMap.class, this, ModelPackage.PRODUCT_INTERFACE_MAP__PRODUCT_PAD_MAP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.PRODUCT_INTERFACE_MAP__XREF_CONNECTION:
				return basicSetXRefConnection(null, msgs);
			case ModelPackage.PRODUCT_INTERFACE_MAP__PRODUCT_PIN_MAP:
				return ((InternalEList<?>)getProductPinMap()).basicRemove(otherEnd, msgs);
			case ModelPackage.PRODUCT_INTERFACE_MAP__PRODUCT_PAD_MAP:
