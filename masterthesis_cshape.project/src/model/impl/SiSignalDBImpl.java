 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SiSignalDBImpl#getSiSignal <em>Si Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiSignalDBImpl extends ModelRootImpl implements SiSignalDB {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getSiSignalDB();
	}
	...
	public EList<SiSignal> getSiSignal() {
		if (siSignal == null) {
			siSignal = new EObjectContainmentEList<SiSignal>(SiSignal.class, this, ModelPackage.SI_SIGNAL_DB__SI_SIGNAL);
		}
		return siSignal;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SI_SIGNAL_DB__SI_SIGNAL:
