 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.PadTypeImpl#getLib <em>Lib</em>}</li>
 *   <li>{@link model.impl.PadTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link model.impl.PadTypeImpl#getDriverStrength <em>Driver Strength</em>}</li>
 *   <li>{@link model.impl.PadTypeImpl#getSet <em>Set</em>}</li>
 *   <li>{@link model.impl.PadTypeImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link model.impl.PadTypeImpl#getSpec <em>Spec</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PadTypeImpl extends SingleSourceNodeImpl implements PadType {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getPadType();
	}
	...
	public void setLib(String newLib) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_TYPE__LIB, oldLib, lib));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_TYPE__TYPE, oldType, type));
	}
	...
	public void setDriverStrength(String newDriverStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_TYPE__DRIVER_STRENGTH, oldDriverStrength, driverStrength));
	}
	...
	public void setSet(String newSet) {
		...
		set = newSet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_TYPE__SET, oldSet, set));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_TYPE__WIDTH, oldWidth, width));
	}
	...
	public void setSpec(String newSpec) {
		...
		spec = newSpec;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_TYPE__SPEC, oldSpec, spec));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.PAD_TYPE__LIB:
				return getLib();
			case ModelPackage.PAD_TYPE__TYPE:
				return getType();
			case ModelPackage.PAD_TYPE__DRIVER_STRENGTH:
				return getDriverStrength();
			case ModelPackage.PAD_TYPE__SET:
				return getSet();
			case ModelPackage.PAD_TYPE__WIDTH:
				return getWidth();
			case ModelPackage.PAD_TYPE__SPEC:
				return getSpec();
		}
