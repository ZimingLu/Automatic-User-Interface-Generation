 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ProductPinMapImpl#getXRefPin <em>XRef Pin</em>}</li>
 *   <li>{@link model.impl.ProductPinMapImpl#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductPinMapImpl extends SingleSourceNodeImpl implements ProductPinMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getProductPinMap();
	}
	...
	public NotificationChain basicSetXRefPin(XRefIndPin newXRefPin, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.PRODUCT_PIN_MAP__XREF_PIN, oldXRefPin, newXRefPin);
	...
	public void setXRefPin(XRefIndPin newXRefPin) {
		if (newXRefPin != xRefPin) {
			...
			if (xRefPin != null)
				msgs = ((InternalEObject)xRefPin).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PRODUCT_PIN_MAP__XREF_PIN, null, msgs);
			if (newXRefPin != null)
				msgs = ((InternalEObject)newXRefPin).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PRODUCT_PIN_MAP__XREF_PIN, null, msgs);
			msgs = basicSetXRefPin(newXRefPin, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PRODUCT_PIN_MAP__XREF_PIN, newXRefPin, newXRefPin));
	}
	...
	public NotificationChain basicSetXRefSignal(XRefInternalSignal newXRefSignal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.PRODUCT_PIN_MAP__XREF_SIGNAL, oldXRefSignal, newXRefSignal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefSignal(XRefInternalSignal newXRefSignal) {
		if (newXRefSignal != xRefSignal) {
			NotificationChain msgs = null;
			if (xRefSignal != null)
				msgs = ((InternalEObject)xRefSignal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PRODUCT_PIN_MAP__XREF_SIGNAL, null, msgs);
			if (newXRefSignal != null)
				msgs = ((InternalEObject)newXRefSignal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PRODUCT_PIN_MAP__XREF_SIGNAL, null, msgs);
			msgs = basicSetXRefSignal(newXRefSignal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PRODUCT_PIN_MAP__XREF_SIGNAL, newXRefSignal, newXRefSignal));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.PRODUCT_PIN_MAP__XREF_PIN:
				return basicSetXRefPin(null, msgs);
			case ModelPackage.PRODUCT_PIN_MAP__XREF_SIGNAL:
