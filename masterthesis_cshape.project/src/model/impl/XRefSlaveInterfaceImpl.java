 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.XRefSlaveInterfaceImpl#getRange <em>Range</em>}</li>
 *   <li>{@link model.impl.XRefSlaveInterfaceImpl#getSrcOffset <em>Src Offset</em>}</li>
 *   <li>{@link model.impl.XRefSlaveInterfaceImpl#getTgtOffset <em>Tgt Offset</em>}</li>
 *   <li>{@link model.impl.XRefSlaveInterfaceImpl#getXRefInstance <em>XRef Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XRefSlaveInterfaceImpl extends XRefExternalImpl implements XRefSlaveInterface {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getXRefSlaveInterface();
	}
	...
	public void setRange(String newRange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.XREF_SLAVE_INTERFACE__RANGE, oldRange, range));
	}
	...
	public void setSrcOffset(String newSrcOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.XREF_SLAVE_INTERFACE__SRC_OFFSET, oldSrcOffset, srcOffset));
	}
	...
	public void setTgtOffset(String newTgtOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.XREF_SLAVE_INTERFACE__TGT_OFFSET, oldTgtOffset, tgtOffset));
	}
	...
	public NotificationChain basicSetXRefInstance(XRefInstance newXRefInstance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.XREF_SLAVE_INTERFACE__XREF_INSTANCE, oldXRefInstance, newXRefInstance);
	...
	public void setXRefInstance(XRefInstance newXRefInstance) {
		if (newXRefInstance != xRefInstance) {
			...
			if (xRefInstance != null)
				msgs = ((InternalEObject)xRefInstance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XREF_SLAVE_INTERFACE__XREF_INSTANCE, null, msgs);
			if (newXRefInstance != null)
				msgs = ((InternalEObject)newXRefInstance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XREF_SLAVE_INTERFACE__XREF_INSTANCE, null, msgs);
			msgs = basicSetXRefInstance(newXRefInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.XREF_SLAVE_INTERFACE__XREF_INSTANCE, newXRefInstance, newXRefInstance));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.XREF_SLAVE_INTERFACE__XREF_INSTANCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.XREF_SLAVE_INTERFACE__RANGE:
				return getRange();
			case ModelPackage.XREF_SLAVE_INTERFACE__SRC_OFFSET:
				return getSrcOffset();
			case ModelPackage.XREF_SLAVE_INTERFACE__TGT_OFFSET:
				return getTgtOffset();
			case ModelPackage.XREF_SLAVE_INTERFACE__XREF_INSTANCE:
