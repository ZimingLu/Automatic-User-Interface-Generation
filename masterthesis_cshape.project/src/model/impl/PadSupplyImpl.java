 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.PadSupplyImpl#getSpec <em>Spec</em>}</li>
 *   <li>{@link model.impl.PadSupplyImpl#getXRefPowerDomain <em>XRef Power Domain</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PadSupplyImpl extends GeneralPadImpl implements PadSupply {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getPadSupply();
	}
	...
	public void setSpec(String newSpec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_SUPPLY__SPEC, oldSpec, spec));
	}
	...
	public NotificationChain basicSetXRefPowerDomain(XRefPowerDomain newXRefPowerDomain, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_SUPPLY__XREF_POWER_DOMAIN, oldXRefPowerDomain, newXRefPowerDomain);
	...
	public void setXRefPowerDomain(XRefPowerDomain newXRefPowerDomain) {
		if (newXRefPowerDomain != xRefPowerDomain) {
			...
			if (xRefPowerDomain != null)
				msgs = ((InternalEObject)xRefPowerDomain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PAD_SUPPLY__XREF_POWER_DOMAIN, null, msgs);
			if (newXRefPowerDomain != null)
				msgs = ((InternalEObject)newXRefPowerDomain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PAD_SUPPLY__XREF_POWER_DOMAIN, null, msgs);
			msgs = basicSetXRefPowerDomain(newXRefPowerDomain, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_SUPPLY__XREF_POWER_DOMAIN, newXRefPowerDomain, newXRefPowerDomain));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.PAD_SUPPLY__XREF_POWER_DOMAIN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.PAD_SUPPLY__SPEC:
				return getSpec();
			case ModelPackage.PAD_SUPPLY__XREF_POWER_DOMAIN:
