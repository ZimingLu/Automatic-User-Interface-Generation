 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.MultiPadImpl#getSinglePad <em>Single Pad</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiPadImpl extends PadImpl implements MultiPad {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getMultiPad();
	}
	...
	public EList<SinglePad> getSinglePad() {
		if (singlePad == null) {
			singlePad = new EObjectContainmentEList<SinglePad>(SinglePad.class, this, ModelPackage.MULTI_PAD__SINGLE_PAD);
		}
		return singlePad;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.MULTI_PAD__SINGLE_PAD:
