 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.InterfacePortMapImpl#getXRefLocalPort <em>XRef Local Port</em>}</li>
 *   <li>{@link model.impl.InterfacePortMapImpl#getXRefInterfacePort <em>XRef Interface Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfacePortMapImpl extends EssenceBaseImpl implements InterfacePortMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getInterfacePortMap();
	}
	...
	public NotificationChain basicSetXRefLocalPort(XRefInternalPort newXRefLocalPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.INTERFACE_PORT_MAP__XREF_LOCAL_PORT, oldXRefLocalPort, newXRefLocalPort);
	...
	public void setXRefLocalPort(XRefInternalPort newXRefLocalPort) {
		if (newXRefLocalPort != xRefLocalPort) {
			...
			if (xRefLocalPort != null)
				msgs = ((InternalEObject)xRefLocalPort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INTERFACE_PORT_MAP__XREF_LOCAL_PORT, null, msgs);
			if (newXRefLocalPort != null)
				msgs = ((InternalEObject)newXRefLocalPort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INTERFACE_PORT_MAP__XREF_LOCAL_PORT, null, msgs);
			msgs = basicSetXRefLocalPort(newXRefLocalPort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INTERFACE_PORT_MAP__XREF_LOCAL_PORT, newXRefLocalPort, newXRefLocalPort));
	}
	...
	public NotificationChain basicSetXRefInterfacePort(XRefIFDPort newXRefInterfacePort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.INTERFACE_PORT_MAP__XREF_INTERFACE_PORT, oldXRefInterfacePort, newXRefInterfacePort);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefInterfacePort(XRefIFDPort newXRefInterfacePort) {
		if (newXRefInterfacePort != xRefInterfacePort) {
			...
			if (xRefInterfacePort != null)
				msgs = ((InternalEObject)xRefInterfacePort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INTERFACE_PORT_MAP__XREF_INTERFACE_PORT, null, msgs);
			if (newXRefInterfacePort != null)
				msgs = ((InternalEObject)newXRefInterfacePort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INTERFACE_PORT_MAP__XREF_INTERFACE_PORT, null, msgs);
			msgs = basicSetXRefInterfacePort(newXRefInterfacePort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INTERFACE_PORT_MAP__XREF_INTERFACE_PORT, newXRefInterfacePort, newXRefInterfacePort));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.INTERFACE_PORT_MAP__XREF_LOCAL_PORT:
				return basicSetXRefLocalPort(null, msgs);
			case ModelPackage.INTERFACE_PORT_MAP__XREF_INTERFACE_PORT:
