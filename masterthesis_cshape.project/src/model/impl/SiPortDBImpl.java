 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SiPortDBImpl#getSiPort <em>Si Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiPortDBImpl extends ModelRootImpl implements SiPortDB {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getSiPortDB();
	}
	...
	public EList<SiPort> getSiPort() {
		if (siPort == null) {
			siPort = new EObjectContainmentEList<SiPort>(SiPort.class, this, ModelPackage.SI_PORT_DB__SI_PORT);
		}
		return siPort;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SI_PORT_DB__SI_PORT:
