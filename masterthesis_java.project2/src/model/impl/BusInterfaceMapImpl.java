 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.BusInterfaceMapImpl#getXRefConnection <em>XRef Connection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BusInterfaceMapImpl extends SingleSourceNodeImpl implements BusInterfaceMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getBusInterfaceMap();
	}
	...
	public NotificationChain basicSetXRefConnection(XRefConnection newXRefConnection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.BUS_INTERFACE_MAP__XREF_CONNECTION, oldXRefConnection, newXRefConnection);
	...
	public void setXRefConnection(XRefConnection newXRefConnection) {
		if (newXRefConnection != xRefConnection) {
			...
			if (xRefConnection != null)
				msgs = ((InternalEObject)xRefConnection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.BUS_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			if (newXRefConnection != null)
				msgs = ((InternalEObject)newXRefConnection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.BUS_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			msgs = basicSetXRefConnection(newXRefConnection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.BUS_INTERFACE_MAP__XREF_CONNECTION, newXRefConnection, newXRefConnection));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.BUS_INTERFACE_MAP__XREF_CONNECTION:
