 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.XRefInternalSignalImpl#getSubElementAccess <em>Sub Element Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XRefInternalSignalImpl extends XRefInternalImpl implements XRefInternalSignal {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getXRefInternalSignal();
	}
	...
	public NotificationChain basicSetSubElementAccess(SubElementAccess newSubElementAccess, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.XREF_INTERNAL_SIGNAL__SUB_ELEMENT_ACCESS, oldSubElementAccess, newSubElementAccess);
	...
	public void setSubElementAccess(SubElementAccess newSubElementAccess) {
		if (newSubElementAccess != subElementAccess) {
			...
			if (subElementAccess != null)
				msgs = ((InternalEObject)subElementAccess).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XREF_INTERNAL_SIGNAL__SUB_ELEMENT_ACCESS, null, msgs);
			if (newSubElementAccess != null)
				msgs = ((InternalEObject)newSubElementAccess).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XREF_INTERNAL_SIGNAL__SUB_ELEMENT_ACCESS, null, msgs);
			msgs = basicSetSubElementAccess(newSubElementAccess, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.XREF_INTERNAL_SIGNAL__SUB_ELEMENT_ACCESS, newSubElementAccess, newSubElementAccess));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.XREF_INTERNAL_SIGNAL__SUB_ELEMENT_ACCESS:
