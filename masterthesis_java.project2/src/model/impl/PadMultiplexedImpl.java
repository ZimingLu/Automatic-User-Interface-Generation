 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.PadMultiplexedImpl#getExtVLNV <em>Ext VLNV</em>}</li>
 *   <li>{@link model.impl.PadMultiplexedImpl#getXRefPort <em>XRef Port</em>}</li>
 *   <li>{@link model.impl.PadMultiplexedImpl#getPortGroup <em>Port Group</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PadMultiplexedImpl extends SinglePadImpl implements PadMultiplexed {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getPadMultiplexed();
	}
	...
	public EList<VLNV> getExtVLNV() {
		if (extVLNV == null) {
			extVLNV = new EObjectContainmentEList<VLNV>(VLNV.class, this, ModelPackage.PAD_MULTIPLEXED__EXT_VLNV);
		}
		return extVLNV;
	}
	...
	public NotificationChain basicSetXRefPort(XRefSiPort newXRefPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_MULTIPLEXED__XREF_PORT, oldXRefPort, newXRefPort);
	...
	public void setXRefPort(XRefSiPort newXRefPort) {
		if (newXRefPort != xRefPort) {
			...
			if (xRefPort != null)
				msgs = ((InternalEObject)xRefPort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PAD_MULTIPLEXED__XREF_PORT, null, msgs);
			if (newXRefPort != null)
				msgs = ((InternalEObject)newXRefPort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PAD_MULTIPLEXED__XREF_PORT, null, msgs);
			msgs = basicSetXRefPort(newXRefPort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_MULTIPLEXED__XREF_PORT, newXRefPort, newXRefPort));
	}
	...
	public void setPortGroup(String newPortGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAD_MULTIPLEXED__PORT_GROUP, oldPortGroup, portGroup));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.PAD_MULTIPLEXED__EXT_VLNV:
				return ((InternalEList<?>)getExtVLNV()).basicRemove(otherEnd, msgs);
			case ModelPackage.PAD_MULTIPLEXED__XREF_PORT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.PAD_MULTIPLEXED__XREF_PORT:
				return getXRefPort();
			case ModelPackage.PAD_MULTIPLEXED__PORT_GROUP:
				return getPortGroup();
		}
