 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.PowerDomainImpl#getPowerConsumption <em>Power Consumption</em>}</li>
 *   <li>{@link model.impl.PowerDomainImpl#getMaxCurrent <em>Max Current</em>}</li>
 *   <li>{@link model.impl.PowerDomainImpl#getAverageCurrent <em>Average Current</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PowerDomainImpl extends SingleSourceNodeImpl implements PowerDomain {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getPowerDomain();
	}
	...
	public void setPowerConsumption(String newPowerConsumption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POWER_DOMAIN__POWER_CONSUMPTION, oldPowerConsumption, powerConsumption));
	}
	...
	public void setMaxCurrent(String newMaxCurrent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POWER_DOMAIN__MAX_CURRENT, oldMaxCurrent, maxCurrent));
	}
	...
	public void setAverageCurrent(String newAverageCurrent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POWER_DOMAIN__AVERAGE_CURRENT, oldAverageCurrent, averageCurrent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.POWER_DOMAIN__POWER_CONSUMPTION:
				return getPowerConsumption();
			case ModelPackage.POWER_DOMAIN__MAX_CURRENT:
				return getMaxCurrent();
			case ModelPackage.POWER_DOMAIN__AVERAGE_CURRENT:
