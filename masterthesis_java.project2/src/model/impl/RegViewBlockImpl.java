 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.RegViewBlockImpl#getRegisterView <em>Register View</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegViewBlockImpl extends SingleSourceNodeImpl implements RegViewBlock {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getRegViewBlock();
	}
	...
	public EList<RegisterView> getRegisterView() {
		if (registerView == null) {
			registerView = new EObjectContainmentEList<RegisterView>(RegisterView.class, this, ModelPackage.REG_VIEW_BLOCK__REGISTER_VIEW);
		}
		return registerView;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.REG_VIEW_BLOCK__REGISTER_VIEW:
