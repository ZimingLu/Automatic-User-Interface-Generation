 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.RegMemSequenceImpl#getCount <em>Count</em>}</li>
 *   <li>{@link model.impl.RegMemSequenceImpl#getMinIndex <em>Min Index</em>}</li>
 *   <li>{@link model.impl.RegMemSequenceImpl#getIndexStep <em>Index Step</em>}</li>
 *   <li>{@link model.impl.RegMemSequenceImpl#getIndexVar <em>Index Var</em>}</li>
 *   <li>{@link model.impl.RegMemSequenceImpl#getAltFormat <em>Alt Format</em>}</li>
 *   <li>{@link model.impl.RegMemSequenceImpl#isPilot <em>Pilot</em>}</li>
 *   <li>{@link model.impl.RegMemSequenceImpl#getSequenceElement <em>Sequence Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegMemSequenceImpl extends RegMemElementImpl implements RegMemSequence {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getRegMemSequence();
	}
	...
	public void setCount(String newCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REG_MEM_SEQUENCE__COUNT, oldCount, count));
	}
	...
	public void setMinIndex(String newMinIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REG_MEM_SEQUENCE__MIN_INDEX, oldMinIndex, minIndex));
	}
	...
	public void setIndexStep(String newIndexStep) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REG_MEM_SEQUENCE__INDEX_STEP, oldIndexStep, indexStep));
	}
	...
	public void setIndexVar(String newIndexVar) {
		...
		indexVarESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REG_MEM_SEQUENCE__INDEX_VAR, oldIndexVar, indexVar, !oldIndexVarESet));
	}
	...
	public void unsetIndexVar() {
		...
		indexVarESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.REG_MEM_SEQUENCE__INDEX_VAR, oldIndexVar, INDEX_VAR_EDEFAULT, oldIndexVarESet));
	}
	...
	public void setAltFormat(String newAltFormat) {
		...
		altFormatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REG_MEM_SEQUENCE__ALT_FORMAT, oldAltFormat, altFormat, !oldAltFormatESet));
	}
	...
	public void unsetAltFormat() {
		...
		altFormatESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.REG_MEM_SEQUENCE__ALT_FORMAT, oldAltFormat, ALT_FORMAT_EDEFAULT, oldAltFormatESet));
	}
	...
	public void setPilot(boolean newPilot) {
		...
		pilot = newPilot;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REG_MEM_SEQUENCE__PILOT, oldPilot, pilot));
	}
	...
	public EList<RegMemElement> getSequenceElement() {
		if (sequenceElement == null) {
			sequenceElement = new EObjectContainmentEList<RegMemElement>(RegMemElement.class, this, ModelPackage.REG_MEM_SEQUENCE__SEQUENCE_ELEMENT);
		}
	 ...
	 * @generated
	 */
	public EList<RegMemElement> getElement() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.REG_MEM_SEQUENCE__SEQUENCE_ELEMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.REG_MEM_SEQUENCE__COUNT:
				return getCount();
			case ModelPackage.REG_MEM_SEQUENCE__MIN_INDEX:
				return getMinIndex();
			case ModelPackage.REG_MEM_SEQUENCE__INDEX_STEP:
				return getIndexStep();
			case ModelPackage.REG_MEM_SEQUENCE__INDEX_VAR:
				return getIndexVar();
			case ModelPackage.REG_MEM_SEQUENCE__ALT_FORMAT:
				return getAltFormat();
			case ModelPackage.REG_MEM_SEQUENCE__PILOT:
				return isPilot();
			case ModelPackage.REG_MEM_SEQUENCE__SEQUENCE_ELEMENT:
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == OffsetSequenceElement.class) {
			switch (baseOperationID) {
				case ModelextensionPackage.OFFSET_SEQUENCE_ELEMENT___GET_LENGTH__MAP: return ModelPackage.REG_MEM_SEQUENCE___GET_LENGTH__MAP;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == RegMemElement.class) {
			switch (baseOperationID) {
				case ModelPackage.REG_MEM_ELEMENT___GET_LENGTH__MAP: return ModelPackage.REG_MEM_SEQUENCE___GET_LENGTH__MAP;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == SequenceBase.class) {
			switch (baseOperationID) {
				case ModelextensionPackage.SEQUENCE_BASE___GET_COUNT_VALUE__MAP: return ModelPackage.REG_MEM_SEQUENCE___GET_COUNT_VALUE__MAP;
				case ModelextensionPackage.SEQUENCE_BASE___GET_MIN_INDEX_VALUE__MAP: return ModelPackage.REG_MEM_SEQUENCE___GET_MIN_INDEX_VALUE__MAP;
				case ModelextensionPackage.SEQUENCE_BASE___GET_INDEX_STEP_VALUE__MAP: return ModelPackage.REG_MEM_SEQUENCE___GET_INDEX_STEP_VALUE__MAP;
				case ModelextensionPackage.SEQUENCE_BASE___GET_INDEX_VAR: return ModelPackage.REG_MEM_SEQUENCE___GET_INDEX_VAR;
				case ModelextensionPackage.SEQUENCE_BASE___GET_ELEMENT: return ModelPackage.REG_MEM_SEQUENCE___GET_ELEMENT;
				case ModelextensionPackage.SEQUENCE_BASE___GET_ALT_FORMAT: return ModelPackage.REG_MEM_SEQUENCE___GET_ALT_FORMAT;
				default: return -1;
			}
		}
		if (baseClass == OffsetSequence.class) {
			switch (baseOperationID) {
				case ModelextensionPackage.OFFSET_SEQUENCE___GET_LENGTH__MAP: return ModelPackage.REG_MEM_SEQUENCE___GET_LENGTH__MAP;
				case ModelextensionPackage.OFFSET_SEQUENCE___GET_ELEMENT: return ModelPackage.REG_MEM_SEQUENCE___GET_ELEMENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ModelPackage.REG_MEM_SEQUENCE___GET_ELEMENT:
				return getElement();
			case ModelPackage.REG_MEM_SEQUENCE___GET_LENGTH__MAP:
				return getLength((Map<String, Integer>)arguments.get(0));
			case ModelPackage.REG_MEM_SEQUENCE___GET_COUNT_VALUE__MAP:
				return getCountValue((Map<String, Integer>)arguments.get(0));
			case ModelPackage.REG_MEM_SEQUENCE___GET_MIN_INDEX_VALUE__MAP:
				return getMinIndexValue((Map<String, Integer>)arguments.get(0));
			case ModelPackage.REG_MEM_SEQUENCE___GET_INDEX_STEP_VALUE__MAP:
