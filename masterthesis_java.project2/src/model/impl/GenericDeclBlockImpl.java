 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.GenericDeclBlockImpl#getGenericDecl <em>Generic Decl</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenericDeclBlockImpl extends VarDefBlockImpl implements GenericDeclBlock {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getGenericDeclBlock();
	}
	...
	public EList<GenericDecl> getGenericDecl() {
		if (genericDecl == null) {
			genericDecl = new EObjectContainmentEList<GenericDecl>(GenericDecl.class, this, ModelPackage.GENERIC_DECL_BLOCK__GENERIC_DECL);
		}
		return genericDecl;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.GENERIC_DECL_BLOCK__GENERIC_DECL:
