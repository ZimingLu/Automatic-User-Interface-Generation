 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.InstanceShellInterfaceMapImpl#getXRefInstanceShellInterface <em>XRef Instance Shell Interface</em>}</li>
 *   <li>{@link model.impl.InstanceShellInterfaceMapImpl#getXRefConnection <em>XRef Connection</em>}</li>
 *   <li>{@link model.impl.InstanceShellInterfaceMapImpl#getInstanceShellPortMap <em>Instance Shell Port Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstanceShellInterfaceMapImpl extends SingleSourceNodeImpl implements InstanceShellInterfaceMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getInstanceShellInterfaceMap();
	}
	...
	public NotificationChain basicSetXRefInstanceShellInterface(XRefIndInterface newXRefInstanceShellInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE, oldXRefInstanceShellInterface, newXRefInstanceShellInterface);
	...
	public void setXRefInstanceShellInterface(XRefIndInterface newXRefInstanceShellInterface) {
		if (newXRefInstanceShellInterface != xRefInstanceShellInterface) {
			...
			if (xRefInstanceShellInterface != null)
				msgs = ((InternalEObject)xRefInstanceShellInterface).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE, null, msgs);
			if (newXRefInstanceShellInterface != null)
				msgs = ((InternalEObject)newXRefInstanceShellInterface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE, null, msgs);
			msgs = basicSetXRefInstanceShellInterface(newXRefInstanceShellInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE, newXRefInstanceShellInterface, newXRefInstanceShellInterface));
	}
	...
	public NotificationChain basicSetXRefConnection(XRefConnection newXRefConnection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_CONNECTION, oldXRefConnection, newXRefConnection);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefConnection(XRefConnection newXRefConnection) {
		if (newXRefConnection != xRefConnection) {
			...
			if (xRefConnection != null)
				msgs = ((InternalEObject)xRefConnection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			if (newXRefConnection != null)
				msgs = ((InternalEObject)newXRefConnection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			msgs = basicSetXRefConnection(newXRefConnection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_CONNECTION, newXRefConnection, newXRefConnection));
	}
	...
	public EList<InstanceShellPortMap> getInstanceShellPortMap() {
		if (instanceShellPortMap == null) {
			instanceShellPortMap = new EObjectContainmentEList<InstanceShellPortMap>(InstanceShellPortMap.class, this, ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__INSTANCE_SHELL_PORT_MAP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_INSTANCE_SHELL_INTERFACE:
				return basicSetXRefInstanceShellInterface(null, msgs);
			case ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__XREF_CONNECTION:
				return basicSetXRefConnection(null, msgs);
			case ModelPackage.INSTANCE_SHELL_INTERFACE_MAP__INSTANCE_SHELL_PORT_MAP:
