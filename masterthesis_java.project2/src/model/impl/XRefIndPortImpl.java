 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.XRefIndPortImpl#getSubElementAccess <em>Sub Element Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XRefIndPortImpl extends XRefIndirectImpl implements XRefIndPort {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getXRefIndPort();
	}
	...
	public NotificationChain basicSetSubElementAccess(SubElementAccess newSubElementAccess, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.XREF_IND_PORT__SUB_ELEMENT_ACCESS, oldSubElementAccess, newSubElementAccess);
	...
	public void setSubElementAccess(SubElementAccess newSubElementAccess) {
		if (newSubElementAccess != subElementAccess) {
			...
			if (subElementAccess != null)
				msgs = ((InternalEObject)subElementAccess).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XREF_IND_PORT__SUB_ELEMENT_ACCESS, null, msgs);
			if (newSubElementAccess != null)
				msgs = ((InternalEObject)newSubElementAccess).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XREF_IND_PORT__SUB_ELEMENT_ACCESS, null, msgs);
			msgs = basicSetSubElementAccess(newSubElementAccess, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.XREF_IND_PORT__SUB_ELEMENT_ACCESS, newSubElementAccess, newSubElementAccess));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.XREF_IND_PORT__SUB_ELEMENT_ACCESS:
