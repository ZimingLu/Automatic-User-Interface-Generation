 ...
 * </p>
 * <ul>
 *   <li>{@link model.ProductPadMap#getXRefPad <em>XRef Pad</em>}</li>
 *   <li>{@link model.ProductPadMap#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getProductPadMap()
...
public interface ProductPadMap extends SingleSourceNode {
	 ...
	 * @see model.ModelPackage#getProductPadMap_XRefPad()
	...
	/**
	 * Sets the value of the '{@link model.ProductPadMap#getXRefPad <em>XRef Pad</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model.ModelPackage#getProductPadMap_XRefSignal()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link model.ProductPadMap#getXRefSignal <em>XRef Signal</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
