 ...
 * </p>
 * <ul>
 *   <li>{@link model.LocalPortMap#getXRefLocalPort <em>XRef Local Port</em>}</li>
 *   <li>{@link model.LocalPortMap#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getLocalPortMap()
...
public interface LocalPortMap extends SingleSourceNode {
	 ...
	 * @see model.ModelPackage#getLocalPortMap_XRefLocalPort()
	...
	/**
	 * Sets the value of the '{@link model.LocalPortMap#getXRefLocalPort <em>XRef Local Port</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model.ModelPackage#getLocalPortMap_XRefSignal()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link model.LocalPortMap#getXRefSignal <em>XRef Signal</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
