 ...
 * </p>
 * <ul>
 *   <li>{@link model.ProductPinMap#getXRefPin <em>XRef Pin</em>}</li>
 *   <li>{@link model.ProductPinMap#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getProductPinMap()
...
public interface ProductPinMap extends SingleSourceNode {
	 ...
	 * @see model.ModelPackage#getProductPinMap_XRefPin()
	...
	/**
	 * Sets the value of the '{@link model.ProductPinMap#getXRefPin <em>XRef Pin</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model.ModelPackage#getProductPinMap_XRefSignal()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link model.ProductPinMap#getXRefSignal <em>XRef Signal</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
