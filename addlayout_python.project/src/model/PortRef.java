 ...
 * </p>
 * <ul>
 *   <li>{@link model.PortRef#getXRefLocalPort <em>XRef Local Port</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getPortRef()
...
public interface PortRef extends Port {
	 ...
	 * @see model.ModelPackage#getPortRef_XRefLocalPort()
	...
	/**
	 * Sets the value of the '{@link model.PortRef#getXRefLocalPort <em>XRef Local Port</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
