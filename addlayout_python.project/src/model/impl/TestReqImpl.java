 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.TestReqImpl#getDriverStrength <em>Driver Strength</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestReqImpl extends EssenceBaseImpl implements TestReq {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getTestReq();
	}
	...
	public void setDriverStrength(String newDriverStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TEST_REQ__DRIVER_STRENGTH, oldDriverStrength, driverStrength));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.TEST_REQ__DRIVER_STRENGTH:
