 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ResetTypeImpl#getResetLevel <em>Reset Level</em>}</li>
 *   <li>{@link model.impl.ResetTypeImpl#getResetMask <em>Reset Mask</em>}</li>
 *   <li>{@link model.impl.ResetTypeImpl#getResetMode <em>Reset Mode</em>}</li>
 *   <li>{@link model.impl.ResetTypeImpl#getResetType <em>Reset Type</em>}</li>
 *   <li>{@link model.impl.ResetTypeImpl#getResetValue <em>Reset Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResetTypeImpl extends IndexVarUserImpl implements ResetType {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getResetType();
	}
	...
	public void setResetLevel(String newResetLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.RESET_TYPE__RESET_LEVEL, oldResetLevel, resetLevel));
	}
	...
	public void setResetMask(String newResetMask) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.RESET_TYPE__RESET_MASK, oldResetMask, resetMask));
	}
	...
	public void setResetMode(SyncMode newResetMode) {
		...
		resetModeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.RESET_TYPE__RESET_MODE, oldResetMode, resetMode, !oldResetModeESet));
	}
	...
	public void unsetResetMode() {
		...
		resetModeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.RESET_TYPE__RESET_MODE, oldResetMode, RESET_MODE_EDEFAULT, oldResetModeESet));
	}
	...
	public void setResetType(String newResetType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.RESET_TYPE__RESET_TYPE, oldResetType, resetType));
	}
	...
	public void setResetValue(String newResetValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.RESET_TYPE__RESET_VALUE, oldResetValue, resetValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.RESET_TYPE__RESET_LEVEL:
				return getResetLevel();
			case ModelPackage.RESET_TYPE__RESET_MASK:
				return getResetMask();
			case ModelPackage.RESET_TYPE__RESET_MODE:
				return getResetMode();
			case ModelPackage.RESET_TYPE__RESET_TYPE:
				return getResetType();
			case ModelPackage.RESET_TYPE__RESET_VALUE:
