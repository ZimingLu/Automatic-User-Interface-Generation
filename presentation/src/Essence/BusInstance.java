 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.BusInstance#getBusInterfaceMap <em>Bus Interface Map</em>}</li>
 *   <li>{@link Essence.BusInstance#getBusNoneInterfaceMap <em>Bus None Interface Map</em>}</li>
 * </ul>
 *
 * @see Essence.EssencePackage#getBusInstance()
...
public interface BusInstance extends Instance {
	 ...
	 * The list contents are of type {@link Essence.BusInterfaceMap}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see Essence.EssencePackage#getBusInstance_BusInterfaceMap()
	 ...
	 * The list contents are of type {@link Essence.BusNoneInterfaceMap}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see Essence.EssencePackage#getBusInstance_BusNoneInterfaceMap()
	 * @model containment="true"
