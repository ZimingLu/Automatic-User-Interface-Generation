 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.AccessConditionImpl#getAccessLevel <em>Access Level</em>}</li>
 *   <li>{@link Essence.impl.AccessConditionImpl#getBusErrorType <em>Bus Error Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccessConditionImpl extends IndexVarUserImpl implements AccessCondition {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getAccessCondition();
	}
	...
	public void setAccessLevel(String newAccessLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.ACCESS_CONDITION__ACCESS_LEVEL, oldAccessLevel, accessLevel));
	}
	...
	public void setBusErrorType(BusErrorType newBusErrorType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.ACCESS_CONDITION__BUS_ERROR_TYPE, oldBusErrorType, busErrorType, !oldBusErrorTypeESet));
	}
	...
	public void unsetBusErrorType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EssencePackage.ACCESS_CONDITION__BUS_ERROR_TYPE, oldBusErrorType, BUS_ERROR_TYPE_EDEFAULT, oldBusErrorTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.ACCESS_CONDITION__ACCESS_LEVEL:
				return getAccessLevel();
			case EssencePackage.ACCESS_CONDITION__BUS_ERROR_TYPE:
