 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.InterfaceInstanceImpl#getInstanceInterfaceMap <em>Instance Interface Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class InterfaceInstanceImpl extends InstanceImpl implements InterfaceInstance {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getInterfaceInstance();
	}
	...
	public EList<InstanceInterfaceMap> getInstanceInterfaceMap() {
		if (instanceInterfaceMap == null) {
			instanceInterfaceMap = new EObjectContainmentEList<InstanceInterfaceMap>(InstanceInterfaceMap.class, this, EssencePackage.INTERFACE_INSTANCE__INSTANCE_INTERFACE_MAP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.INTERFACE_INSTANCE__INSTANCE_INTERFACE_MAP:
