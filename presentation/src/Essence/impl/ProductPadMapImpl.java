 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.ProductPadMapImpl#getXRefPad <em>XRef Pad</em>}</li>
 *   <li>{@link Essence.impl.ProductPadMapImpl#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductPadMapImpl extends SingleSourceNodeImpl implements ProductPadMap {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getProductPadMap();
	}
	...
	public NotificationChain basicSetXRefPad(XRefIndSinglePad newXRefPad, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.PRODUCT_PAD_MAP__XREF_PAD, oldXRefPad, newXRefPad);
	...
	public void setXRefPad(XRefIndSinglePad newXRefPad) {
		if (newXRefPad != xRefPad) {
			...
			if (xRefPad != null)
				msgs = ((InternalEObject)xRefPad).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.PRODUCT_PAD_MAP__XREF_PAD, null, msgs);
			if (newXRefPad != null)
				msgs = ((InternalEObject)newXRefPad).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.PRODUCT_PAD_MAP__XREF_PAD, null, msgs);
			msgs = basicSetXRefPad(newXRefPad, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.PRODUCT_PAD_MAP__XREF_PAD, newXRefPad, newXRefPad));
	}
	...
	public NotificationChain basicSetXRefSignal(XRefInternalSignal newXRefSignal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.PRODUCT_PAD_MAP__XREF_SIGNAL, oldXRefSignal, newXRefSignal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefSignal(XRefInternalSignal newXRefSignal) {
		if (newXRefSignal != xRefSignal) {
			NotificationChain msgs = null;
			if (xRefSignal != null)
				msgs = ((InternalEObject)xRefSignal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.PRODUCT_PAD_MAP__XREF_SIGNAL, null, msgs);
			if (newXRefSignal != null)
				msgs = ((InternalEObject)newXRefSignal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.PRODUCT_PAD_MAP__XREF_SIGNAL, null, msgs);
			msgs = basicSetXRefSignal(newXRefSignal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.PRODUCT_PAD_MAP__XREF_SIGNAL, newXRefSignal, newXRefSignal));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.PRODUCT_PAD_MAP__XREF_PAD:
				return basicSetXRefPad(null, msgs);
			case EssencePackage.PRODUCT_PAD_MAP__XREF_SIGNAL:
