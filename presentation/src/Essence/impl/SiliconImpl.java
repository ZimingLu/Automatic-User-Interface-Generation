 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.SiliconImpl#getStep <em>Step</em>}</li>
 *   <li>{@link Essence.impl.SiliconImpl#getPadHeight <em>Pad Height</em>}</li>
 *   <li>{@link Essence.impl.SiliconImpl#getKerfWidth <em>Kerf Width</em>}</li>
 *   <li>{@link Essence.impl.SiliconImpl#getKerfHeight <em>Kerf Height</em>}</li>
 *   <li>{@link Essence.impl.SiliconImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link Essence.impl.SiliconImpl#getPad <em>Pad</em>}</li>
 *   <li>{@link Essence.impl.SiliconImpl#getPowerDomain <em>Power Domain</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiliconImpl extends ModelRootImpl implements Silicon {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getSilicon();
	}
	...
	public void setStep(String newStep) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SILICON__STEP, oldStep, step));
	}
	...
	public void setPadHeight(String newPadHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SILICON__PAD_HEIGHT, oldPadHeight, padHeight));
	}
	...
	public void setKerfWidth(String newKerfWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SILICON__KERF_WIDTH, oldKerfWidth, kerfWidth));
	}
	...
	public void setKerfHeight(String newKerfHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SILICON__KERF_HEIGHT, oldKerfHeight, kerfHeight));
	}
	...
	public EList<SiInstance> getInstance() {
		if (instance == null) {
			instance = new EObjectContainmentEList<SiInstance>(SiInstance.class, this, EssencePackage.SILICON__INSTANCE);
		}
		return instance;
	}
	...
	public EList<Pad> getPad() {
		if (pad == null) {
			pad = new EObjectContainmentEList<Pad>(Pad.class, this, EssencePackage.SILICON__PAD);
		}
		return pad;
	}
	...
	public EList<PowerDomain> getPowerDomain() {
		if (powerDomain == null) {
			powerDomain = new EObjectContainmentEList<PowerDomain>(PowerDomain.class, this, EssencePackage.SILICON__POWER_DOMAIN);
		}
		return powerDomain;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.SILICON__STEP:
				return getStep();
			case EssencePackage.SILICON__PAD_HEIGHT:
				return getPadHeight();
			case EssencePackage.SILICON__KERF_WIDTH:
				return getKerfWidth();
			case EssencePackage.SILICON__KERF_HEIGHT:
