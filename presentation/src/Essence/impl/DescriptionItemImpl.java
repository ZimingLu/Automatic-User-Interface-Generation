 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.DescriptionItemImpl#getHtml <em>Html</em>}</li>
 *   <li>{@link Essence.impl.DescriptionItemImpl#getDita <em>Dita</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DescriptionItemImpl extends EssenceBaseImpl implements DescriptionItem {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getDescriptionItem();
	}
	...
	public void setHtml(String newHtml) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.DESCRIPTION_ITEM__HTML, oldHtml, html));
	}
	...
	public void setDita(String newDita) {
		...
		dita = newDita;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.DESCRIPTION_ITEM__DITA, oldDita, dita));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.DESCRIPTION_ITEM__HTML:
				return getHtml();
			case EssencePackage.DESCRIPTION_ITEM__DITA:
				return getDita();
		}
