 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.AccessByIndexImpl#isAscending <em>Ascending</em>}</li>
 *   <li>{@link Essence.impl.AccessByIndexImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link Essence.impl.AccessByIndexImpl#getRight <em>Right</em>}</li>
 *   <li>{@link Essence.impl.AccessByIndexImpl#getSimpleSubElementAccess <em>Simple Sub Element Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccessByIndexImpl extends SimpleSubElementAccessImpl implements AccessByIndex {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getAccessByIndex();
	}
	...
	public void setAscending(boolean newAscending) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.ACCESS_BY_INDEX__ASCENDING, oldAscending, ascending, !oldAscendingESet));
	}
	...
	public void unsetAscending() {
		...
		ascendingESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EssencePackage.ACCESS_BY_INDEX__ASCENDING, oldAscending, ASCENDING_EDEFAULT, oldAscendingESet));
	}
	...
	public void setLeft(String newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.ACCESS_BY_INDEX__LEFT, oldLeft, left));
	}
	...
	public void setRight(String newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.ACCESS_BY_INDEX__RIGHT, oldRight, right));
	}
	...
	public NotificationChain basicSetSimpleSubElementAccess(SimpleSubElementAccess newSimpleSubElementAccess, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.ACCESS_BY_INDEX__SIMPLE_SUB_ELEMENT_ACCESS, oldSimpleSubElementAccess, newSimpleSubElementAccess);
	...
	public void setSimpleSubElementAccess(SimpleSubElementAccess newSimpleSubElementAccess) {
		if (newSimpleSubElementAccess != simpleSubElementAccess) {
			...
			if (simpleSubElementAccess != null)
				msgs = ((InternalEObject)simpleSubElementAccess).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.ACCESS_BY_INDEX__SIMPLE_SUB_ELEMENT_ACCESS, null, msgs);
			if (newSimpleSubElementAccess != null)
				msgs = ((InternalEObject)newSimpleSubElementAccess).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.ACCESS_BY_INDEX__SIMPLE_SUB_ELEMENT_ACCESS, null, msgs);
			msgs = basicSetSimpleSubElementAccess(newSimpleSubElementAccess, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.ACCESS_BY_INDEX__SIMPLE_SUB_ELEMENT_ACCESS, newSimpleSubElementAccess, newSimpleSubElementAccess));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.ACCESS_BY_INDEX__SIMPLE_SUB_ELEMENT_ACCESS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.ACCESS_BY_INDEX__ASCENDING:
				return isAscending();
			case EssencePackage.ACCESS_BY_INDEX__LEFT:
				return getLeft();
			case EssencePackage.ACCESS_BY_INDEX__RIGHT:
				return getRight();
			case EssencePackage.ACCESS_BY_INDEX__SIMPLE_SUB_ELEMENT_ACCESS:
