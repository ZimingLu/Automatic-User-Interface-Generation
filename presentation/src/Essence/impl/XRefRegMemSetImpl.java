 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.XRefRegMemSetImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link Essence.impl.XRefRegMemSetImpl#getAccessCondition <em>Access Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XRefRegMemSetImpl extends XRefInternalImpl implements XRefRegMemSet {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getXRefRegMemSet();
	}
	...
	public void setOffset(String newOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.XREF_REG_MEM_SET__OFFSET, oldOffset, offset));
	}
	...
	public EList<AccessCondition> getAccessCondition() {
		if (accessCondition == null) {
			accessCondition = new EObjectContainmentEList<AccessCondition>(AccessCondition.class, this, EssencePackage.XREF_REG_MEM_SET__ACCESS_CONDITION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.XREF_REG_MEM_SET__ACCESS_CONDITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.XREF_REG_MEM_SET__OFFSET:
				return getOffset();
			case EssencePackage.XREF_REG_MEM_SET__ACCESS_CONDITION:
