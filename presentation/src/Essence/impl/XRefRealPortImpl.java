 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.XRefRealPortImpl#getSubElementAccess <em>Sub Element Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XRefRealPortImpl extends XRefInternalImpl implements XRefRealPort {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getXRefRealPort();
	}
	...
	public NotificationChain basicSetSubElementAccess(SubElementAccess newSubElementAccess, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.XREF_REAL_PORT__SUB_ELEMENT_ACCESS, oldSubElementAccess, newSubElementAccess);
	...
	public void setSubElementAccess(SubElementAccess newSubElementAccess) {
		if (newSubElementAccess != subElementAccess) {
			...
			if (subElementAccess != null)
				msgs = ((InternalEObject)subElementAccess).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.XREF_REAL_PORT__SUB_ELEMENT_ACCESS, null, msgs);
			if (newSubElementAccess != null)
				msgs = ((InternalEObject)newSubElementAccess).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.XREF_REAL_PORT__SUB_ELEMENT_ACCESS, null, msgs);
			msgs = basicSetSubElementAccess(newSubElementAccess, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.XREF_REAL_PORT__SUB_ELEMENT_ACCESS, newSubElementAccess, newSubElementAccess));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.XREF_REAL_PORT__SUB_ELEMENT_ACCESS:
