 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.RecordImpl#getDataTypeElement <em>Data Type Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RecordImpl extends ComplexDataTypeImpl implements Record {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getRecord();
	}
	...
	public EList<DataTypeElement> getDataTypeElement() {
		if (dataTypeElement == null) {
			dataTypeElement = new EObjectContainmentEList<DataTypeElement>(DataTypeElement.class, this, EssencePackage.RECORD__DATA_TYPE_ELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.RECORD__DATA_TYPE_ELEMENT:
