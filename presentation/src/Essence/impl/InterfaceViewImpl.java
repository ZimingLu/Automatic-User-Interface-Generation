 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.InterfaceViewImpl#getInterfacePortMap <em>Interface Port Map</em>}</li>
 *   <li>{@link Essence.impl.InterfaceViewImpl#getPort <em>Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceViewImpl extends SingleSourceNodeImpl implements InterfaceView {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getInterfaceView();
	}
	...
	public EList<InterfacePortMap> getInterfacePortMap() {
		if (interfacePortMap == null) {
			interfacePortMap = new EObjectContainmentEList<InterfacePortMap>(InterfacePortMap.class, this, EssencePackage.INTERFACE_VIEW__INTERFACE_PORT_MAP);
		}
	...
	public EList<Port> getPort() {
		if (port == null) {
			port = new EObjectContainmentEList<Port>(Port.class, this, EssencePackage.INTERFACE_VIEW__PORT);
		}
		return port;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.INTERFACE_VIEW__INTERFACE_PORT_MAP:
				return ((InternalEList<?>)getInterfacePortMap()).basicRemove(otherEnd, msgs);
			case EssencePackage.INTERFACE_VIEW__PORT:
