 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.SiliconInstanceImpl#getPadNetMap <em>Pad Net Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiliconInstanceImpl extends GeneralInstanceImpl implements SiliconInstance {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getSiliconInstance();
	}
	...
	public EList<PadNetMap> getPadNetMap() {
		if (padNetMap == null) {
			padNetMap = new EObjectContainmentEList<PadNetMap>(PadNetMap.class, this, EssencePackage.SILICON_INSTANCE__PAD_NET_MAP);
		}
		return padNetMap;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.SILICON_INSTANCE__PAD_NET_MAP:
