 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.BusNoneInterfaceMapImpl#getXRefBusNoneInterface <em>XRef Bus None Interface</em>}</li>
 *   <li>{@link Essence.impl.BusNoneInterfaceMapImpl#getXRefConnection <em>XRef Connection</em>}</li>
 *   <li>{@link Essence.impl.BusNoneInterfaceMapImpl#getInstancePortMap <em>Instance Port Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BusNoneInterfaceMapImpl extends SingleSourceNodeImpl implements BusNoneInterfaceMap {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getBusNoneInterfaceMap();
	}
	...
	public NotificationChain basicSetXRefBusNoneInterface(XRefNoneInterface newXRefBusNoneInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_BUS_NONE_INTERFACE, oldXRefBusNoneInterface, newXRefBusNoneInterface);
	...
	public void setXRefBusNoneInterface(XRefNoneInterface newXRefBusNoneInterface) {
		if (newXRefBusNoneInterface != xRefBusNoneInterface) {
			...
			if (xRefBusNoneInterface != null)
				msgs = ((InternalEObject)xRefBusNoneInterface).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_BUS_NONE_INTERFACE, null, msgs);
			if (newXRefBusNoneInterface != null)
				msgs = ((InternalEObject)newXRefBusNoneInterface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_BUS_NONE_INTERFACE, null, msgs);
			msgs = basicSetXRefBusNoneInterface(newXRefBusNoneInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_BUS_NONE_INTERFACE, newXRefBusNoneInterface, newXRefBusNoneInterface));
	}
	...
	public NotificationChain basicSetXRefConnection(XRefConnection newXRefConnection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_CONNECTION, oldXRefConnection, newXRefConnection);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefConnection(XRefConnection newXRefConnection) {
		if (newXRefConnection != xRefConnection) {
			...
			if (xRefConnection != null)
				msgs = ((InternalEObject)xRefConnection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			if (newXRefConnection != null)
				msgs = ((InternalEObject)newXRefConnection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_CONNECTION, null, msgs);
			msgs = basicSetXRefConnection(newXRefConnection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_CONNECTION, newXRefConnection, newXRefConnection));
	}
	...
	public EList<InstancePortMap> getInstancePortMap() {
		if (instancePortMap == null) {
			instancePortMap = new EObjectContainmentEList<InstancePortMap>(InstancePortMap.class, this, EssencePackage.BUS_NONE_INTERFACE_MAP__INSTANCE_PORT_MAP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_BUS_NONE_INTERFACE:
				return basicSetXRefBusNoneInterface(null, msgs);
			case EssencePackage.BUS_NONE_INTERFACE_MAP__XREF_CONNECTION:
				return basicSetXRefConnection(null, msgs);
			case EssencePackage.BUS_NONE_INTERFACE_MAP__INSTANCE_PORT_MAP:
