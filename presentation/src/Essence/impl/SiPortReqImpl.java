 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.SiPortReqImpl#getDriverStrength <em>Driver Strength</em>}</li>
 *   <li>{@link Essence.impl.SiPortReqImpl#getSet <em>Set</em>}</li>
 *   <li>{@link Essence.impl.SiPortReqImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiPortReqImpl extends EssenceBaseImpl implements SiPortReq {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getSiPortReq();
	}
	...
	public void setDriverStrength(String newDriverStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SI_PORT_REQ__DRIVER_STRENGTH, oldDriverStrength, driverStrength));
	}
	...
	public void setSet(String newSet) {
		...
		set = newSet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SI_PORT_REQ__SET, oldSet, set));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SI_PORT_REQ__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.SI_PORT_REQ__DRIVER_STRENGTH:
				return getDriverStrength();
			case EssencePackage.SI_PORT_REQ__SET:
				return getSet();
			case EssencePackage.SI_PORT_REQ__TYPE:
				return getType();
		}
