 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.MemoryImpl#getAccessType <em>Access Type</em>}</li>
 *   <li>{@link Essence.impl.MemoryImpl#getSize <em>Size</em>}</li>
 *   <li>{@link Essence.impl.MemoryImpl#getEndianness <em>Endianness</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemoryImpl extends SequenceElementImpl implements Memory {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getMemory();
	}
	...
	public void setAccessType(AccessType newAccessType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.MEMORY__ACCESS_TYPE, oldAccessType, accessType, !oldAccessTypeESet));
	}
	...
	public void unsetAccessType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EssencePackage.MEMORY__ACCESS_TYPE, oldAccessType, ACCESS_TYPE_EDEFAULT, oldAccessTypeESet));
	}
	...
	public void setSize(String newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.MEMORY__SIZE, oldSize, size));
	}
	...
	public void setEndianness(EndianType newEndianness) {
		...
		endiannessESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.MEMORY__ENDIANNESS, oldEndianness, endianness, !oldEndiannessESet));
	}
	...
	public void unsetEndianness() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EssencePackage.MEMORY__ENDIANNESS, oldEndianness, ENDIANNESS_EDEFAULT, oldEndiannessESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.MEMORY__ACCESS_TYPE:
				return getAccessType();
			case EssencePackage.MEMORY__SIZE:
				return getSize();
			case EssencePackage.MEMORY__ENDIANNESS:
