 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.SiInstanceInterfaceMapImpl#getXRefInstanceInterface <em>XRef Instance Interface</em>}</li>
 *   <li>{@link Essence.impl.SiInstanceInterfaceMapImpl#getSiInstancePortMap <em>Si Instance Port Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiInstanceInterfaceMapImpl extends SingleSourceNodeImpl implements SiInstanceInterfaceMap {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getSiInstanceInterfaceMap();
	}
	...
	public NotificationChain basicSetXRefInstanceInterface(XRefExternalInterface newXRefInstanceInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.SI_INSTANCE_INTERFACE_MAP__XREF_INSTANCE_INTERFACE, oldXRefInstanceInterface, newXRefInstanceInterface);
	...
	public void setXRefInstanceInterface(XRefExternalInterface newXRefInstanceInterface) {
		if (newXRefInstanceInterface != xRefInstanceInterface) {
			...
			if (xRefInstanceInterface != null)
				msgs = ((InternalEObject)xRefInstanceInterface).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SI_INSTANCE_INTERFACE_MAP__XREF_INSTANCE_INTERFACE, null, msgs);
			if (newXRefInstanceInterface != null)
				msgs = ((InternalEObject)newXRefInstanceInterface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SI_INSTANCE_INTERFACE_MAP__XREF_INSTANCE_INTERFACE, null, msgs);
			msgs = basicSetXRefInstanceInterface(newXRefInstanceInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SI_INSTANCE_INTERFACE_MAP__XREF_INSTANCE_INTERFACE, newXRefInstanceInterface, newXRefInstanceInterface));
	}
	...
	public EList<SiInstancePortMap> getSiInstancePortMap() {
		if (siInstancePortMap == null) {
			siInstancePortMap = new EObjectContainmentEList<SiInstancePortMap>(SiInstancePortMap.class, this, EssencePackage.SI_INSTANCE_INTERFACE_MAP__SI_INSTANCE_PORT_MAP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.SI_INSTANCE_INTERFACE_MAP__XREF_INSTANCE_INTERFACE:
				return basicSetXRefInstanceInterface(null, msgs);
			case EssencePackage.SI_INSTANCE_INTERFACE_MAP__SI_INSTANCE_PORT_MAP:
