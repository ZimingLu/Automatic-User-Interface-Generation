 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.GeneralPadImpl#getXRefPadType <em>XRef Pad Type</em>}</li>
 *   <li>{@link Essence.impl.GeneralPadImpl#getLib <em>Lib</em>}</li>
 *   <li>{@link Essence.impl.GeneralPadImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GeneralPadImpl extends SinglePadImpl implements GeneralPad {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getGeneralPad();
	}
	...
	public NotificationChain basicSetXRefPadType(XRefPadType newXRefPadType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.GENERAL_PAD__XREF_PAD_TYPE, oldXRefPadType, newXRefPadType);
	...
	public void setXRefPadType(XRefPadType newXRefPadType) {
		if (newXRefPadType != xRefPadType) {
			...
			if (xRefPadType != null)
				msgs = ((InternalEObject)xRefPadType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.GENERAL_PAD__XREF_PAD_TYPE, null, msgs);
			if (newXRefPadType != null)
				msgs = ((InternalEObject)newXRefPadType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.GENERAL_PAD__XREF_PAD_TYPE, null, msgs);
			msgs = basicSetXRefPadType(newXRefPadType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.GENERAL_PAD__XREF_PAD_TYPE, newXRefPadType, newXRefPadType));
	}
	...
	public void setLib(String newLib) {
		...
		lib = newLib;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.GENERAL_PAD__LIB, oldLib, lib));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.GENERAL_PAD__WIDTH, oldWidth, width));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.GENERAL_PAD__XREF_PAD_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EssencePackage.GENERAL_PAD__LIB:
				return getLib();
			case EssencePackage.GENERAL_PAD__WIDTH:
				return getWidth();
		}
