 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.PortRefImpl#getXRefLocalPort <em>XRef Local Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PortRefImpl extends PortImpl implements PortRef {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getPortRef();
	}
	...
	public NotificationChain basicSetXRefLocalPort(XRefRealPort newXRefLocalPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.PORT_REF__XREF_LOCAL_PORT, oldXRefLocalPort, newXRefLocalPort);
	...
	public void setXRefLocalPort(XRefRealPort newXRefLocalPort) {
		if (newXRefLocalPort != xRefLocalPort) {
			...
			if (xRefLocalPort != null)
				msgs = ((InternalEObject)xRefLocalPort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.PORT_REF__XREF_LOCAL_PORT, null, msgs);
			if (newXRefLocalPort != null)
				msgs = ((InternalEObject)newXRefLocalPort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.PORT_REF__XREF_LOCAL_PORT, null, msgs);
			msgs = basicSetXRefLocalPort(newXRefLocalPort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.PORT_REF__XREF_LOCAL_PORT, newXRefLocalPort, newXRefLocalPort));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.PORT_REF__XREF_LOCAL_PORT:
