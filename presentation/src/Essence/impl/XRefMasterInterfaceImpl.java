 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.XRefMasterInterfaceImpl#getRange <em>Range</em>}</li>
 *   <li>{@link Essence.impl.XRefMasterInterfaceImpl#getSrcOffset <em>Src Offset</em>}</li>
 *   <li>{@link Essence.impl.XRefMasterInterfaceImpl#getTgtOffset <em>Tgt Offset</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XRefMasterInterfaceImpl extends XRefInternalImpl implements XRefMasterInterface {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getXRefMasterInterface();
	}
	...
	public void setRange(String newRange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.XREF_MASTER_INTERFACE__RANGE, oldRange, range));
	}
	...
	public void setSrcOffset(String newSrcOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.XREF_MASTER_INTERFACE__SRC_OFFSET, oldSrcOffset, srcOffset));
	}
	...
	public void setTgtOffset(String newTgtOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.XREF_MASTER_INTERFACE__TGT_OFFSET, oldTgtOffset, tgtOffset));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.XREF_MASTER_INTERFACE__RANGE:
				return getRange();
			case EssencePackage.XREF_MASTER_INTERFACE__SRC_OFFSET:
				return getSrcOffset();
			case EssencePackage.XREF_MASTER_INTERFACE__TGT_OFFSET:
				return getTgtOffset();
		}
