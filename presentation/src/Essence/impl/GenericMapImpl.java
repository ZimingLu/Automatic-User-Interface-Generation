 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.GenericMapImpl#getXRefGenericDecl <em>XRef Generic Decl</em>}</li>
 *   <li>{@link Essence.impl.GenericMapImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenericMapImpl extends SingleSourceNodeImpl implements GenericMap {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getGenericMap();
	}
	...
	public NotificationChain basicSetXRefGenericDecl(XRefGenericDecl newXRefGenericDecl, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.GENERIC_MAP__XREF_GENERIC_DECL, oldXRefGenericDecl, newXRefGenericDecl);
	...
	public void setXRefGenericDecl(XRefGenericDecl newXRefGenericDecl) {
		if (newXRefGenericDecl != xRefGenericDecl) {
			...
			if (xRefGenericDecl != null)
				msgs = ((InternalEObject)xRefGenericDecl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.GENERIC_MAP__XREF_GENERIC_DECL, null, msgs);
			if (newXRefGenericDecl != null)
				msgs = ((InternalEObject)newXRefGenericDecl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.GENERIC_MAP__XREF_GENERIC_DECL, null, msgs);
			msgs = basicSetXRefGenericDecl(newXRefGenericDecl, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.GENERIC_MAP__XREF_GENERIC_DECL, newXRefGenericDecl, newXRefGenericDecl));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.GENERIC_MAP__VALUE, oldValue, value));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.GENERIC_MAP__XREF_GENERIC_DECL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EssencePackage.GENERIC_MAP__VALUE:
				return getValue();
		}
