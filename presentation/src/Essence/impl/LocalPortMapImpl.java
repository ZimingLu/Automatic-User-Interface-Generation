 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.LocalPortMapImpl#getXRefLocalPort <em>XRef Local Port</em>}</li>
 *   <li>{@link Essence.impl.LocalPortMapImpl#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocalPortMapImpl extends SingleSourceNodeImpl implements LocalPortMap {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getLocalPortMap();
	}
	...
	public NotificationChain basicSetXRefLocalPort(XRefInternalPort newXRefLocalPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.LOCAL_PORT_MAP__XREF_LOCAL_PORT, oldXRefLocalPort, newXRefLocalPort);
	...
	public void setXRefLocalPort(XRefInternalPort newXRefLocalPort) {
		if (newXRefLocalPort != xRefLocalPort) {
			...
			if (xRefLocalPort != null)
				msgs = ((InternalEObject)xRefLocalPort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.LOCAL_PORT_MAP__XREF_LOCAL_PORT, null, msgs);
			if (newXRefLocalPort != null)
				msgs = ((InternalEObject)newXRefLocalPort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.LOCAL_PORT_MAP__XREF_LOCAL_PORT, null, msgs);
			msgs = basicSetXRefLocalPort(newXRefLocalPort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.LOCAL_PORT_MAP__XREF_LOCAL_PORT, newXRefLocalPort, newXRefLocalPort));
	}
	...
	public NotificationChain basicSetXRefSignal(XRefInternalSignal newXRefSignal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.LOCAL_PORT_MAP__XREF_SIGNAL, oldXRefSignal, newXRefSignal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefSignal(XRefInternalSignal newXRefSignal) {
		if (newXRefSignal != xRefSignal) {
			NotificationChain msgs = null;
			if (xRefSignal != null)
				msgs = ((InternalEObject)xRefSignal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.LOCAL_PORT_MAP__XREF_SIGNAL, null, msgs);
			if (newXRefSignal != null)
				msgs = ((InternalEObject)newXRefSignal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.LOCAL_PORT_MAP__XREF_SIGNAL, null, msgs);
			msgs = basicSetXRefSignal(newXRefSignal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.LOCAL_PORT_MAP__XREF_SIGNAL, newXRefSignal, newXRefSignal));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.LOCAL_PORT_MAP__XREF_LOCAL_PORT:
				return basicSetXRefLocalPort(null, msgs);
			case EssencePackage.LOCAL_PORT_MAP__XREF_SIGNAL:
