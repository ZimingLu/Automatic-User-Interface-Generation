 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.SignalMapImpl#getXRefLocalSignal <em>XRef Local Signal</em>}</li>
 *   <li>{@link Essence.impl.SignalMapImpl#getXRefInterfaceDefSignal <em>XRef Interface Def Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignalMapImpl extends EssenceBaseImpl implements SignalMap {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getSignalMap();
	}
	...
	public NotificationChain basicSetXRefLocalSignal(XRefInternalSignal newXRefLocalSignal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.SIGNAL_MAP__XREF_LOCAL_SIGNAL, oldXRefLocalSignal, newXRefLocalSignal);
	...
	public void setXRefLocalSignal(XRefInternalSignal newXRefLocalSignal) {
		if (newXRefLocalSignal != xRefLocalSignal) {
			...
			if (xRefLocalSignal != null)
				msgs = ((InternalEObject)xRefLocalSignal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SIGNAL_MAP__XREF_LOCAL_SIGNAL, null, msgs);
			if (newXRefLocalSignal != null)
				msgs = ((InternalEObject)newXRefLocalSignal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SIGNAL_MAP__XREF_LOCAL_SIGNAL, null, msgs);
			msgs = basicSetXRefLocalSignal(newXRefLocalSignal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SIGNAL_MAP__XREF_LOCAL_SIGNAL, newXRefLocalSignal, newXRefLocalSignal));
	}
	...
	public NotificationChain basicSetXRefInterfaceDefSignal(XRefExternalSignal newXRefInterfaceDefSignal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.SIGNAL_MAP__XREF_INTERFACE_DEF_SIGNAL, oldXRefInterfaceDefSignal, newXRefInterfaceDefSignal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefInterfaceDefSignal(XRefExternalSignal newXRefInterfaceDefSignal) {
		if (newXRefInterfaceDefSignal != xRefInterfaceDefSignal) {
			...
			if (xRefInterfaceDefSignal != null)
				msgs = ((InternalEObject)xRefInterfaceDefSignal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SIGNAL_MAP__XREF_INTERFACE_DEF_SIGNAL, null, msgs);
			if (newXRefInterfaceDefSignal != null)
				msgs = ((InternalEObject)newXRefInterfaceDefSignal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SIGNAL_MAP__XREF_INTERFACE_DEF_SIGNAL, null, msgs);
			msgs = basicSetXRefInterfaceDefSignal(newXRefInterfaceDefSignal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SIGNAL_MAP__XREF_INTERFACE_DEF_SIGNAL, newXRefInterfaceDefSignal, newXRefInterfaceDefSignal));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.SIGNAL_MAP__XREF_LOCAL_SIGNAL:
				return basicSetXRefLocalSignal(null, msgs);
			case EssencePackage.SIGNAL_MAP__XREF_INTERFACE_DEF_SIGNAL:
