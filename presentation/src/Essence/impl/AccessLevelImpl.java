 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.AccessLevelImpl#getAccessLevel <em>Access Level</em>}</li>
 *   <li>{@link Essence.impl.AccessLevelImpl#getAccessType <em>Access Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccessLevelImpl extends IndexVarUserImpl implements AccessLevel {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getAccessLevel();
	}
	...
	public void setAccessLevel(String newAccessLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.ACCESS_LEVEL__ACCESS_LEVEL, oldAccessLevel, accessLevel));
	}
	...
	public void setAccessType(AccessType newAccessType) {
		...
		accessTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.ACCESS_LEVEL__ACCESS_TYPE, oldAccessType, accessType, !oldAccessTypeESet));
	}
	...
	public void unsetAccessType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EssencePackage.ACCESS_LEVEL__ACCESS_TYPE, oldAccessType, ACCESS_TYPE_EDEFAULT, oldAccessTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.ACCESS_LEVEL__ACCESS_LEVEL:
				return getAccessLevel();
			case EssencePackage.ACCESS_LEVEL__ACCESS_TYPE:
