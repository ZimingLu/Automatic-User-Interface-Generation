 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.ShellPortMapImpl#getXRefShellPort <em>XRef Shell Port</em>}</li>
 *   <li>{@link Essence.impl.ShellPortMapImpl#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShellPortMapImpl extends SingleSourceNodeImpl implements ShellPortMap {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getShellPortMap();
	}
	...
	public NotificationChain basicSetXRefShellPort(XRefExternalPort newXRefShellPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.SHELL_PORT_MAP__XREF_SHELL_PORT, oldXRefShellPort, newXRefShellPort);
	...
	public void setXRefShellPort(XRefExternalPort newXRefShellPort) {
		if (newXRefShellPort != xRefShellPort) {
			...
			if (xRefShellPort != null)
				msgs = ((InternalEObject)xRefShellPort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SHELL_PORT_MAP__XREF_SHELL_PORT, null, msgs);
			if (newXRefShellPort != null)
				msgs = ((InternalEObject)newXRefShellPort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SHELL_PORT_MAP__XREF_SHELL_PORT, null, msgs);
			msgs = basicSetXRefShellPort(newXRefShellPort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SHELL_PORT_MAP__XREF_SHELL_PORT, newXRefShellPort, newXRefShellPort));
	}
	...
	public NotificationChain basicSetXRefSignal(XRefInternalSignal newXRefSignal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.SHELL_PORT_MAP__XREF_SIGNAL, oldXRefSignal, newXRefSignal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefSignal(XRefInternalSignal newXRefSignal) {
		if (newXRefSignal != xRefSignal) {
			NotificationChain msgs = null;
			if (xRefSignal != null)
				msgs = ((InternalEObject)xRefSignal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SHELL_PORT_MAP__XREF_SIGNAL, null, msgs);
			if (newXRefSignal != null)
				msgs = ((InternalEObject)newXRefSignal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.SHELL_PORT_MAP__XREF_SIGNAL, null, msgs);
			msgs = basicSetXRefSignal(newXRefSignal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.SHELL_PORT_MAP__XREF_SIGNAL, newXRefSignal, newXRefSignal));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.SHELL_PORT_MAP__XREF_SHELL_PORT:
				return basicSetXRefShellPort(null, msgs);
			case EssencePackage.SHELL_PORT_MAP__XREF_SIGNAL:
