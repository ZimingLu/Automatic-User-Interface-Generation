 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.TestImpl#getParallelFactor <em>Parallel Factor</em>}</li>
 *   <li>{@link Essence.impl.TestImpl#getTestReq <em>Test Req</em>}</li>
 *   <li>{@link Essence.impl.TestImpl#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestImpl extends SingleSourceNodeImpl implements Test {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getTest();
	}
	...
	public void setParallelFactor(String newParallelFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.TEST__PARALLEL_FACTOR, oldParallelFactor, parallelFactor));
	}
	...
	public NotificationChain basicSetTestReq(TestReq newTestReq, NotificationChain msgs) {
		...
		testReq = newTestReq;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EssencePackage.TEST__TEST_REQ, oldTestReq, newTestReq);
	...
	public void setTestReq(TestReq newTestReq) {
		if (newTestReq != testReq) {
			...
			if (testReq != null)
				msgs = ((InternalEObject)testReq).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EssencePackage.TEST__TEST_REQ, null, msgs);
			if (newTestReq != null)
				msgs = ((InternalEObject)newTestReq).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EssencePackage.TEST__TEST_REQ, null, msgs);
			msgs = basicSetTestReq(newTestReq, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.TEST__TEST_REQ, newTestReq, newTestReq));
	}
	...
	public EList<Function> getFunction() {
		if (function == null) {
			function = new EObjectContainmentEList<Function>(Function.class, this, EssencePackage.TEST__FUNCTION);
		}
		return function;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EssencePackage.TEST__TEST_REQ:
				return basicSetTestReq(null, msgs);
			case EssencePackage.TEST__FUNCTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.TEST__PARALLEL_FACTOR:
