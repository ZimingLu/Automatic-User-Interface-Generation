 ...
 * </p>
 * <ul>
 *   <li>{@link Essence.impl.RegMemElementImpl#getOffset <em>Offset</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RegMemElementImpl extends IndexVarUserImpl implements RegMemElement {
	...
	protected EClass eStaticClass() {
		return EssencePackage.eINSTANCE.getRegMemElement();
	}
	...
	public void setOffset(String newOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EssencePackage.REG_MEM_ELEMENT__OFFSET, oldOffset, offset));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EssencePackage.REG_MEM_ELEMENT__OFFSET:
				return getOffset();
		}
