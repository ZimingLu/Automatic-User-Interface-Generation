 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.InterfaceDefinitionImpl#getAddressUnit <em>Address Unit</em>}</li>
 *   <li>{@link model.impl.InterfaceDefinitionImpl#getDataUnit <em>Data Unit</em>}</li>
 *   <li>{@link model.impl.InterfaceDefinitionImpl#getExtVLNV <em>Ext VLNV</em>}</li>
 *   <li>{@link model.impl.InterfaceDefinitionImpl#getInterfaceDefView <em>Interface Def View</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceDefinitionImpl extends ModelRootImpl implements InterfaceDefinition {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getInterfaceDefinition();
	}
	...
	public void setAddressUnit(String newAddressUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INTERFACE_DEFINITION__ADDRESS_UNIT, oldAddressUnit, addressUnit));
	}
	...
	public void setDataUnit(String newDataUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INTERFACE_DEFINITION__DATA_UNIT, oldDataUnit, dataUnit));
	}
	...
	public NotificationChain basicSetExtVLNV(VLNV newExtVLNV, NotificationChain msgs) {
		...
		extVLNV = newExtVLNV;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.INTERFACE_DEFINITION__EXT_VLNV, oldExtVLNV, newExtVLNV);
	...
	public void setExtVLNV(VLNV newExtVLNV) {
		if (newExtVLNV != extVLNV) {
			...
			if (extVLNV != null)
				msgs = ((InternalEObject)extVLNV).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INTERFACE_DEFINITION__EXT_VLNV, null, msgs);
			if (newExtVLNV != null)
				msgs = ((InternalEObject)newExtVLNV).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INTERFACE_DEFINITION__EXT_VLNV, null, msgs);
			msgs = basicSetExtVLNV(newExtVLNV, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INTERFACE_DEFINITION__EXT_VLNV, newExtVLNV, newExtVLNV));
	}
	...
	public EList<InterfaceDefView> getInterfaceDefView() {
		if (interfaceDefView == null) {
			interfaceDefView = new EObjectContainmentEList<InterfaceDefView>(InterfaceDefView.class, this, ModelPackage.INTERFACE_DEFINITION__INTERFACE_DEF_VIEW);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.INTERFACE_DEFINITION__EXT_VLNV:
				return basicSetExtVLNV(null, msgs);
			case ModelPackage.INTERFACE_DEFINITION__INTERFACE_DEF_VIEW:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.INTERFACE_DEFINITION__ADDRESS_UNIT:
				return getAddressUnit();
			case ModelPackage.INTERFACE_DEFINITION__DATA_UNIT:
				return getDataUnit();
			case ModelPackage.INTERFACE_DEFINITION__EXT_VLNV:
				return getExtVLNV();
			case ModelPackage.INTERFACE_DEFINITION__INTERFACE_DEF_VIEW:
