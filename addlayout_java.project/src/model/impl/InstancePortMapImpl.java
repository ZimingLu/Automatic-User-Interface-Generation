 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.InstancePortMapImpl#getXRefInstancePort <em>XRef Instance Port</em>}</li>
 *   <li>{@link model.impl.InstancePortMapImpl#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstancePortMapImpl extends SingleSourceNodeImpl implements InstancePortMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getInstancePortMap();
	}
	...
	public NotificationChain basicSetXRefInstancePort(XRefExternalPort newXRefInstancePort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.INSTANCE_PORT_MAP__XREF_INSTANCE_PORT, oldXRefInstancePort, newXRefInstancePort);
	...
	public void setXRefInstancePort(XRefExternalPort newXRefInstancePort) {
		if (newXRefInstancePort != xRefInstancePort) {
			...
			if (xRefInstancePort != null)
				msgs = ((InternalEObject)xRefInstancePort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INSTANCE_PORT_MAP__XREF_INSTANCE_PORT, null, msgs);
			if (newXRefInstancePort != null)
				msgs = ((InternalEObject)newXRefInstancePort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INSTANCE_PORT_MAP__XREF_INSTANCE_PORT, null, msgs);
			msgs = basicSetXRefInstancePort(newXRefInstancePort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INSTANCE_PORT_MAP__XREF_INSTANCE_PORT, newXRefInstancePort, newXRefInstancePort));
	}
	...
	public NotificationChain basicSetXRefSignal(XRefInternalSignal newXRefSignal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.INSTANCE_PORT_MAP__XREF_SIGNAL, oldXRefSignal, newXRefSignal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefSignal(XRefInternalSignal newXRefSignal) {
		if (newXRefSignal != xRefSignal) {
			NotificationChain msgs = null;
			if (xRefSignal != null)
				msgs = ((InternalEObject)xRefSignal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INSTANCE_PORT_MAP__XREF_SIGNAL, null, msgs);
			if (newXRefSignal != null)
				msgs = ((InternalEObject)newXRefSignal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.INSTANCE_PORT_MAP__XREF_SIGNAL, null, msgs);
			msgs = basicSetXRefSignal(newXRefSignal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INSTANCE_PORT_MAP__XREF_SIGNAL, newXRefSignal, newXRefSignal));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.INSTANCE_PORT_MAP__XREF_INSTANCE_PORT:
				return basicSetXRefInstancePort(null, msgs);
			case ModelPackage.INSTANCE_PORT_MAP__XREF_SIGNAL:
