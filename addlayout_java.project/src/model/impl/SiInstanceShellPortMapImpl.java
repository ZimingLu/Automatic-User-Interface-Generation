 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SiInstanceShellPortMapImpl#getXRefInstanceShellPort <em>XRef Instance Shell Port</em>}</li>
 *   <li>{@link model.impl.SiInstanceShellPortMapImpl#getXRefSignal <em>XRef Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiInstanceShellPortMapImpl extends SingleSourceNodeImpl implements SiInstanceShellPortMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getSiInstanceShellPortMap();
	}
	...
	public NotificationChain basicSetXRefInstanceShellPort(XRefIndPort newXRefInstanceShellPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_INSTANCE_SHELL_PORT, oldXRefInstanceShellPort, newXRefInstanceShellPort);
	...
	public void setXRefInstanceShellPort(XRefIndPort newXRefInstanceShellPort) {
		if (newXRefInstanceShellPort != xRefInstanceShellPort) {
			...
			if (xRefInstanceShellPort != null)
				msgs = ((InternalEObject)xRefInstanceShellPort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_INSTANCE_SHELL_PORT, null, msgs);
			if (newXRefInstanceShellPort != null)
				msgs = ((InternalEObject)newXRefInstanceShellPort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_INSTANCE_SHELL_PORT, null, msgs);
			msgs = basicSetXRefInstanceShellPort(newXRefInstanceShellPort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_INSTANCE_SHELL_PORT, newXRefInstanceShellPort, newXRefInstanceShellPort));
	}
	...
	public NotificationChain basicSetXRefSignal(XRefSiSignal newXRefSignal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_SIGNAL, oldXRefSignal, newXRefSignal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXRefSignal(XRefSiSignal newXRefSignal) {
		if (newXRefSignal != xRefSignal) {
			NotificationChain msgs = null;
			if (xRefSignal != null)
				msgs = ((InternalEObject)xRefSignal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_SIGNAL, null, msgs);
			if (newXRefSignal != null)
				msgs = ((InternalEObject)newXRefSignal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_SIGNAL, null, msgs);
			msgs = basicSetXRefSignal(newXRefSignal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_SIGNAL, newXRefSignal, newXRefSignal));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_INSTANCE_SHELL_PORT:
				return basicSetXRefInstanceShellPort(null, msgs);
			case ModelPackage.SI_INSTANCE_SHELL_PORT_MAP__XREF_SIGNAL:
