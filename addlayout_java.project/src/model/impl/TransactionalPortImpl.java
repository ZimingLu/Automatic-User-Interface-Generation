 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.TransactionalPortImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link model.impl.TransactionalPortImpl#getInitiative <em>Initiative</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransactionalPortImpl extends RealPortImpl implements TransactionalPort {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getTransactionalPort();
	}
	...
	public NotificationChain basicSetDataType(MethodDataType newDataType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSACTIONAL_PORT__DATA_TYPE, oldDataType, newDataType);
	...
	public void setDataType(MethodDataType newDataType) {
		if (newDataType != dataType) {
			...
			if (dataType != null)
				msgs = ((InternalEObject)dataType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TRANSACTIONAL_PORT__DATA_TYPE, null, msgs);
			if (newDataType != null)
				msgs = ((InternalEObject)newDataType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TRANSACTIONAL_PORT__DATA_TYPE, null, msgs);
			msgs = basicSetDataType(newDataType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSACTIONAL_PORT__DATA_TYPE, newDataType, newDataType));
	}
	...
	public void setInitiative(PortInitiative newInitiative) {
		...
		initiativeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSACTIONAL_PORT__INITIATIVE, oldInitiative, initiative, !oldInitiativeESet));
	}
	...
	public void unsetInitiative() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TRANSACTIONAL_PORT__INITIATIVE, oldInitiative, INITIATIVE_EDEFAULT, oldInitiativeESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.TRANSACTIONAL_PORT__DATA_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.TRANSACTIONAL_PORT__DATA_TYPE:
				return getDataType();
			case ModelPackage.TRANSACTIONAL_PORT__INITIATIVE:
