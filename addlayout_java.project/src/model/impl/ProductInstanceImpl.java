 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ProductInstanceImpl#getProductInterfaceMap <em>Product Interface Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductInstanceImpl extends InstanceImpl implements ProductInstance {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getProductInstance();
	}
	...
	public EList<ProductInterfaceMap> getProductInterfaceMap() {
		if (productInterfaceMap == null) {
			productInterfaceMap = new EObjectContainmentEList<ProductInterfaceMap>(ProductInterfaceMap.class, this, ModelPackage.PRODUCT_INSTANCE__PRODUCT_INTERFACE_MAP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.PRODUCT_INSTANCE__PRODUCT_INTERFACE_MAP:
