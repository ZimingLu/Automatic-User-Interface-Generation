 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ArrayImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link model.impl.ArrayImpl#getArrayDimension <em>Array Dimension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayImpl extends ComplexDataTypeImpl implements Array {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getArray();
	}
	...
	public NotificationChain basicSetDataType(ValueDataType newDataType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.ARRAY__DATA_TYPE, oldDataType, newDataType);
	...
	public void setDataType(ValueDataType newDataType) {
		if (newDataType != dataType) {
			...
			if (dataType != null)
				msgs = ((InternalEObject)dataType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ARRAY__DATA_TYPE, null, msgs);
			if (newDataType != null)
				msgs = ((InternalEObject)newDataType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ARRAY__DATA_TYPE, null, msgs);
			msgs = basicSetDataType(newDataType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ARRAY__DATA_TYPE, newDataType, newDataType));
	}
	...
	public EList<ArrayDimension> getArrayDimension() {
		if (arrayDimension == null) {
			arrayDimension = new EObjectContainmentEList<ArrayDimension>(ArrayDimension.class, this, ModelPackage.ARRAY__ARRAY_DIMENSION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.ARRAY__DATA_TYPE:
				return basicSetDataType(null, msgs);
			case ModelPackage.ARRAY__ARRAY_DIMENSION:
