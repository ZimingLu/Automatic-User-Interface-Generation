 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ParamMapImpl#getXRefParamDecl <em>XRef Param Decl</em>}</li>
 *   <li>{@link model.impl.ParamMapImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParamMapImpl extends SingleSourceNodeImpl implements ParamMap {
	...
	protected EClass eStaticClass() {
		return ModelPackage.eINSTANCE.getParamMap();
	}
	...
	public NotificationChain basicSetXRefParamDecl(XRefParamDecl newXRefParamDecl, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.PARAM_MAP__XREF_PARAM_DECL, oldXRefParamDecl, newXRefParamDecl);
	...
	public void setXRefParamDecl(XRefParamDecl newXRefParamDecl) {
		if (newXRefParamDecl != xRefParamDecl) {
			...
			if (xRefParamDecl != null)
				msgs = ((InternalEObject)xRefParamDecl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PARAM_MAP__XREF_PARAM_DECL, null, msgs);
			if (newXRefParamDecl != null)
				msgs = ((InternalEObject)newXRefParamDecl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PARAM_MAP__XREF_PARAM_DECL, null, msgs);
			msgs = basicSetXRefParamDecl(newXRefParamDecl, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PARAM_MAP__XREF_PARAM_DECL, newXRefParamDecl, newXRefParamDecl));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PARAM_MAP__VALUE, oldValue, value));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.PARAM_MAP__XREF_PARAM_DECL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.PARAM_MAP__VALUE:
				return getValue();
		}
